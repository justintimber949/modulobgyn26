...
> [!warning] **Red Flag — Torsi Adneksa!**
> Nyeri perut bawah akut unilateral + nyeri goyang portio + mual muntah pada wanita usia reproduksi dengan massa adneksa adalah torsi sampai terbukti lain. **Jangan tunda diagnosis — setiap jam keterlambatan meningkatkan risiko nekrosis ovarium ireversibel.** Target operasi < 4 jam sejak onset nyeri untuk menyelamatkan ovarium!

---

## Definisi

**Torsi kista ovarium (ovarian torsion)** adalah tergulirnya ovarium — dan/atau tuba uterina — pada pedikel vaskularnya (lig. infundibulopelvikum dan lig. ovarii proprium), yang menyebabkan obstruksi aliran vena dan limfatik, diikuti obstruksi arteri, sehingga terjadi iskemia dan nekrosis ovarium.
...
**Obstruksi vena (tekanan rendah) terjadi pertama** → edema ovarium → pembesaran. Disusul **obstruksi arteri (tekanan tinggi)** → iskemia → nyeri hebat. Torsi intermiten (rotasi < 360°) dapat mengalami detorsi spontan — nyeri hilang timbul.

> [!warning] **Waktu Kritis**
> Lesi iskemia ireversibel pada ovarium dalam **36–48 jam**, namun kerusakan klinis signifikan bisa dimulai dalam **4–6 jam**. Derajat torsi (jumlah putaran) dan durasi edema menentukan kecepatan nekrosis. **Semakin dini operasi, semakin baik prognosis ovarium.**
...
> [!tip] **Nyeri Torsi — Karakteristik Khas**
...
- **Gejala penyerta** — mual, muntah, demam (demam → nekrosis sudah lanjut)
- **Riwayat kista/torsi/operasi ovarium** sebelumnya
- **HPHT + siklus haid** — fase luteal? Hamil? (tes kehamilan wajib)
- **Riwayat infertilitas / ovulasi induksi / IVF**
...
> [!warning] **Doppler Normal ≠ Tidak Ada Torsi!**
> Torsi parsial (< 360°) atau intermiten dapat memiliki aliran Doppler yang tampak normal. **Keputusan operasi didasarkan pada klinis + USG B-mode, bukan semata-mata Doppler!**
...
> Massa > 5 cm (1 pt), nyeri hebat akut (1 pt), mual/muntah (1 pt), tidak ada perdarahan (1 pt). **Skor ≥ 3** → sensitivitas 92% untuk torsi.
...
> [!info] **Level 3B: Tatalaksana Awal di Bawah Supervisi SpOG**
> Dokter umum dapat melakukan stabilisasi hemodinamik, analgetik, pemeriksaan penunjang, dan persiapan rujukan. **Torsi kista ovarium adalah kegawatan bedah ginekologi yang memerlukan operasi segera. Jangan menunda rujukan untuk terapi definitif.**
...
4. Syok (curigai ruptur/perdarahan intraabdominal)
5. Kehamilan + torsi (rujuk ke RS dengan SpOG + NICU)
6. Kista dengan fitur keganasan (dinding ireguler, papil, neovaskularisasi)
...
1. **Doppler normal = bukan torsi — jebakan paling berbahaya!** Torsi intermiten atau < 360° bisa menunjukkan aliran arteri normal. **Keputusan operasi: klinis + USG B-mode, bukan Doppler.**

2. **Menunda operasi:** Setiap jam keterlambatan mengurangi peluang menyelamatkan ovarium. Target **< 4 jam**. Torsi adalah darurat, bukan observasi.

3. **Ovarium hitam langsung diangkat:** 80–90% ovarium "hitam" pulih setelah detorsi + observasi 5–10 menit. **Jangan ooforektomi dini** pada pasien usia reproduksi.

4. **Mirip apendisitis:** Nyeri kanan bawah, mual, muntah. **Beda kunci:** nyeri goyang portio (+), massa adneksa, USG Doppler. Bila ragu — USG.

5. **Tidak ooforopeksi:** Risiko rekurensi 5–10%. Prosedur sederhana dan efektif — lakukan setiap kali detorsi.

6. **Anggapan "terlalu muda" untuk torsi:** 15–20% terjadi < 20 tahun. Jangan lewatkan hanya karena usia.

7. **Tunda operasi pada kehamilan:** Justru lebih berbahaya jika tidak dioperasi — nekrosis → peritonitis → abortus. Laparoskopi aman pada kehamilan.

8. **Tidak kirim PA:** 1–2% kista bisa ganas. **Selalu kirim eksplan untuk pemeriksaan patologi anatomi.**
...
4. Detorsi berhasil — ovarium merah muda dalam 7 menit, kistektomi + ooforopeksi
5. PA eksplan: teratoma kistik matang (dermoid) — **jinak**
6. Pulang hari ke-2, kontrol 1 minggu: USG ovarium kanan normal, Doppler (+)

> [!warning] **Evaluasi PA Wajib!**
> Walaupun 98% kista yang torsi bersifat jinak, pemeriksaan PA menyingkirkan kemungkinan karsinoma sel germinal atau tumor borderline ovarium.
...
7. **Selalu kirim PA** — 1–2% kista bisa ganas.
