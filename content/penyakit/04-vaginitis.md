...
> Dokter umum harus mampu mendiagnosis dan menatalaksana vaginitis secara **mandiri dan tuntas**, termasuk membedakan vaginitis dari servisitis, memberikan terapi kausal sesuai agen penyebab, serta melakukan konseling dan edukasi pasien.
...
**Vaginitis** adalah peradangan (inflamasi) pada mukosa vagina. Istilah **kolpitis** kadang digunakan secara bergantian, terutama untuk vaginitis yang disebabkan oleh infeksi spesifik.

Vaginitis merupakan salah satu keluhan ginekologi tersering — diperkirakan **75% wanita** akan mengalami setidaknya satu episode vaginitis dalam hidupnya. Penyebabnya beragam, mulai dari infeksi (jamur, bakteri, protozoa), perubahan hormonal (atrofi menopause), hingga reaksi iritatif/kimia.

> [!warning] **Peringatan Klinis**
> Vaginitis sering disertai **vulvitis** (→ vulvovaginitis), terutama pada infeksi Candida. Namun, vaginitis bisa juga terjadi bersamaan dengan **servisitis** — keduanya punya sumber anatomis berbeda (vagina vs endoserviks). Jangan sampai terkecoh: temukan sumber peradangannya dulu sebelum menentukan terapi.
...
- Imunosupresi (HIV, kortikosteroid jangka panjang)
- Kontrasepsi hormonal dosis tinggi
- Kebiasaan celana ketat / bahan sintetis (kelembaban tinggi)
- Douching berulang
...
- Merokok
- Penggunaan alat kontrasepsi IUD (sedikit meningkatkan risiko)
- Riwayat BV sebelumnya

> [!warning] **BV BUKAN IMS Klasik**
> Bacterial vaginosis memang terkait aktivitas seksual, tetapi tidak disebabkan oleh satu patogen IMS — jadi tidak diperlakukan sebagai IMS. Namun, BV meningkatkan risiko terkena IMS (termasuk HIV) dan komplikasi obstetri. Pengobatan pasangan tidak direkomendasikan secara rutin.
...
- Riwayat IMS lain
- **IMS sejati** — satu-satunya vaginitis yang diklasifikasikan sebagai IMS murni
...
- Pemakaian anti-estrogen (tamoxifen, inhibitor aromatase)
...
- Termal: air panas saat mandi/cebok
...
1. **Karakter duh**: warna, konsistensi, volume, bau — kapan mulai? Apakah berhubungan dengan siklus haid?
2. **Gejala penyerta**: gatal/panas? Nyeri saat BAK/sanggama? Perdarahan kontak?
3. **Riwayat obat**: antibiotik 1–2 bulan terakhir? Kortikosteroid? Kontrasepsi?
4. **Riwayat penyakit sistemik**: DM, HIV, gangguan tiroid, penyakit kulit
5. **Riwayat menopause**: kapan menopause? Terapi hormonal?
6. **Riwayat seksual**: pasangan baru, berganti-ganti, kondom, riwayat IMS
7. **Riwayat kebersihan**: douching? Sabun kewanitaan? Panty liner? Pembalut berparfum?
...
```
Pasien dengan gejala vaginitis (gatal/panas/duh/nyeri)
                    │
                    ▼
            Anamnesis + Spekulum
                    │
                    ├── Duh putih menggumpal, pH < 4,5
                    │       └── Pseudohifa (+) → **Kandidiasis vulvovaginal**
                    │
                    ├── Duh homogen abu-abu, pH > 4,5, bau amis
                    │       └── Clue cell > 20%, Whiff (+) → **Bacterial Vaginosis**
                    │
                    ├── Duh kuning-hijau berbusa, pH > 4,5
                    │       └── Trikomonas motil → **Trikomoniasis**
                    │
                    ├── Vagina kering, tipis, pucat, pH > 4,5
                    │       └── Wanita menopause/tidak haid → **Vaginitis atrofik**
                    │
                    └── Eritema difus, sekret minimal, pH normal
                            └── Riwayat paparan iritan → **Vaginitis iritatif**
```

### Kriteria Diagnosis BV (Kriteria Amsel)
...
1. **Diagnosis spesifik → terapi kausal.** Jangan beri terapi kombinasi (triple therapy) tanpa diagnosis.
2. **Obati sesuai penyebab** — antijamur untuk Candida; metronidazol/klindamisin untuk BV; metronidazol/tinidazol untuk trikomonas; estrogen lokal untuk atrofik; hentikan paparan untuk iritatif.
3. **Obati pasangan** hanya untuk trikomoniasis — untuk BV tidak rutin, untuk Candida tidak perlu (kecuali pasangan bergejala balanitis).
4. **Hindari douching** — edukasi pasien untuk berhenti.
5. **Kontrol DM** pada pasien diabetes dengan kandidiasis rekuren.
...
> [!warning] **BV pada Kehamilan**
> BV pada kehamilan dikaitkan dengan: **ketuban pecah dini (KPD)**, **persalinan preterm**, **korioamnionitis**, dan **endometritis pascapersalinan**. Skrining dan terapi BV dianjurkan pada ibu hamil dengan risiko tinggi preterm. Regimen aman: metronidazol 500 mg 2×/hari × 7 hari (setelah trimester 1) atau klindamisin topikal.
...
- Tambahkan lubrikan berbasis air saat senggama

### 5. Vaginitis Iritatif
...
5. Evaluasi 7 hari: biasanya membaik signifikan tanpa obat spesifik

---

## Yang Sering Jadi Jebakan

> [!tip] **Jebakan #1 — Menganggap semua keputihan adalah Candida**
> Pasien dengan BV sering diresepkan antijamur karena dokter tidak melakukan pemeriksaan pH atau preparat basah. BV butuh metronidazol/klindamisin, bukan antijamur. **Gunakan pH meter dan mikroskop — jangan tebak.**

> [!tip] **Jebakan #2 — Lupa bahwa vaginitis bisa atrofik**
> Wanita menopause dengan keluhan vagina kering, panas, dan nyeri senggama sering disangka infeksi dan diberi antijamur/antibiotik berulang. Padahal tidak ada infeksi — yang kurang adalah estrogen. **Pada wanita menopause, vaginitis atrofik adalah diagnosis tersering, eksklusi dulu sebelum mencari yang lain.**

> [!tip] **Jebakan #3 — Douching atas saran dokter atau bidan**
> Masih banyak tenaga kesehatan yang menyarankan douching atau cairan pembersih vagina untuk "mengobati" keputihan. Ini justru memperburuk vaginitis dengan mengganggu flora normal. **Edukasi: vagina membersihkan dirinya sendiri — tidak perlu douching.**

> [!tip] **Jebakan #4 — Hanya mengobati pasien, pasangan tidak**
...
- Kontrol 2 minggu bila keluhan tidak hilang
...
- Evaluasi 4 minggu — biasanya perbaikan signifikan

> [!note] Kedua pasien pulang dengan pemahaman yang jelas tentang diagnosis dan ekspektasi terapi. Tidak ada yang diberikan antibiotik yang tidak perlu.
...
1. **Jangan tebak — ukur pH dan lihat preparat basah.** pH vagina adalah alat diagnostik paling sederhana yang membedakan Candida (pH normal) dari BV/Trikomonas (pH > 4,5).
2. **Tiga penyebab vaginitis infeksiosa tersering: Candida, BV, Trichomonas.** Ketiganya punya terapi yang berbeda — tidak ada satu obat untuk semua.
3. **Vaginitis atrofik sering terlewat** — pikirkan pada wanita menopause dengan keluhan vagina kering/panas tanpa penyebab infeksi.
4. **Douching adalah musuh** — baik sebagai pencetus maupun pengabur diagnosis.
5. **BV pada bumil: skrining dan tatalaksana** karena risiko KPD dan preterm.
6. **Trikomoniasis: obati pasangan bersamaan** — ini non-negotiable.
7. **Kandidiasis rekuren: cari DM.** Jangan hanya ulang flukonazol tanpa mencari sebab.
