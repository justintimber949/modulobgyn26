...
> Dokter umum harus bisa mendiagnosis dan **tuntas menangani sendiri** kasus sindrom duh genital — baik gonore maupun nongonore. Termasuk memberikan terapi definitif, konseling, dan penanganan pasangan.
...
## Apa Itu Sindrom Duh Genital?

Sindrom duh genital adalah istilah klinis untuk **keluarnya cairan (discharge) dari saluran genital** yang jumlah, warna, konsistensi, atau baunya **menyimpang dari normal** sehingga dikeluhkan pasien. Ini bukan diagnosis final, melainkan **sindrom** — langkah pertama dalam pendekatan diagnosis yang memandu kita ke penyebab yang mendasarinya.
...
> - **Transmisi ke pasangan** / infeksi ulang
> - **Komplikasi kehamilan**: KPD, korioamnionitis, sepsis neonatus, oftalmia neonatorum
...
Kunci membedakan penyebab sindrom duh genital ada pada **wawancara yang saksama**. Jangan malu bertanya riwayat seksual — tanyakan dengan sopan dan tanpa menghakimi.
...
1. **Karakter duh tubuh**: warna, volume, konsistensi, bau, apakah memberat sebelum/ sesudah haid
2. **Gejala penyerta**: gatal, panas, nyeri, perdarahan kontak, disuria
3. **Faktor pencetus**: antibiotik baru, diabetes, kehamilan, kontrasepsi hormonal, douching, ganti pasangan, pasangan baru, pemakaian kondom
4. **Riwayat hubungan seksual**: jumlah pasangan 3 bulan terakhir, jenis hubungan (vaginal/oral/anal), riwayat IMS sebelumnya, status pasangan
5. **Riwayat haid**: siklus, HPHT, kontrasepsi
...
> - Teraba massa adneksa (→ abses / kista ovarium)
> - Tanda peritoneal (→ abdomen akut)
> - Pasien hamil dengan duh patologis + nyeri perut (→ risiko abortus / KPD)
...
> [!tip] Jebakan: Wanita dengan gonore bisa **asimptomatik** pada 50–80% kasus! Jangan pernah eksklusi gonore hanya karena pasien tidak bergejala. Skrining pada kelompok risiko tinggi (pasangan berganti, IMS sebelumnya, < 25 tahun) adalah praktik yang bijak.
...
### Algoritma Diagnosis Sindrom Duh Genital (Pendekatan Sindromik)

```
Pasien dengan duh genital
        │
        ▼
Anamnesis + Pem Fisik + Spekulum
        │
        ├── Duh vagina (+/-) gatal, bau
        │       │
        │       ├── pH < 4,5 + pseudohifa → **Candida vulvovaginitis**
        │       ├── pH > 4,5 + clue cell + Whiff (+) → **Bacterial Vaginosis**
        │       ├── pH > 4,5 + trophozoit aktif → **Trichomoniasis**
        │       └── Jika pasangan duh uretra → **Eksklusi gonore/klamidia**
        │
        └── Duh endoserviks (purulen / mukopurulen)
                │
                ├── Gram diplokokus → **Gonore** (presumtif — konfirmasi NAAT)
                └── PMN > 30/LPB → **Servisitis klamidia / gonore**

    **Selalu tawarkan screening HIV, sifilis, hepatitis B** — ko-infeksi sering!
```
...
1. **Tatalah penyebab spesifik** — jangan hanya "anti-keputihan" generik
2. **Obati pasangan** — terutama gonore, klamidia, trikomonas (pasangan harus diobati meski asimptomatik)
3. **Konseling** — edukasi tentang IMS, pentingnya kondom, dan tes HIV-sifilis
4. **Anjurkan abstinensia** — atau kondom sampai selesai terapi dan kontrol
5. **Tes of Cure** — 7-14 hari pasca terapi untuk gonore & klamidia
6. **Partnership notification** — pasien diminta memberitahu pasangan seksualnya
...
> [!warning] Red Flag: Metronidazole oral **kontraindikasi** pada trimester 1 kehamilan — berikan klindamisin topikal atau metronidazol intravaginal saja. Pada menyusui, tunggu 12-24 jam setelah dosis terakhir metronidazol oral sebelum menyusui.
...
1. **Selesaikan obat** — meski keluhan hilang sebelum obat habis
2. **Pasangan harus diobati** — terutama gonore, klamidia, trikomonas (obati meski tidak bergejala)
3. **Gunakan kondom** — sampai kontrol selesai
4. **Tes HIV + sifilis** — karena ko-infeksi IMS meningkatkan risiko transmisi HIV
5. **Jangan douching** — mengganggu flora normal vagina dan memperburuk infeksi
6. **Kontrol** — 7-14 hari selesai terapi atau jika keluhan menetap

---

## Yang Sering Jadi Jebakan

> [!tip] Jebakan #1 — **Merawat keputihan dengan "obat generik anti-keputihan"**
> Banyak pasien datang sudah membeli obat keputihan di warung atau diapresepsi dokter sebelumnya dengan metronidazol + flukonazol + krim kombinasi (triple therapy) tanpa diagnosis yang jelas. Ini menyebabkan resistensi, overuse antibiotik, dan kegagalan terapi. **Tegakkan diagnosis dulu, baru beri obat spesifik.**

> [!tip] Jebakan #2 — **Pasangan tidak diobati, pasien diobati ulang terus**
> Pasien datang 3× dengan trikomoniasis yang sama. Ternyata suaminya tidak pernah diobati. Aturan besarnya: **obati pasangan yang terinfeksi secara bersamaan.** Kalau pasien perempuan sudah 2× rekuren, curigai reinfeksi dari pasangan yang tidak diobati.

> [!tip] Jebakan #3 — **Lupa skrining HIV dan sifilis**
> Setiap pasien IMS adalah populasi risiko tinggi HIV. Jangan lewatkan kesempatan untuk menawarkan tes HIV dan sifilis. Informed consent dan konseling pra-tes harus dilakukan.

> [!tip] Jebakan #4 — **Memberi metronidazol oral tanpa memeriksa kontraindikasi kehamilan**
> Pada ibu hamil trimester 1, metronidazol oral sebaiknya dihindari. Gunakan klindamisin topikal untuk BV, atau tunda terapi trikomonas ke trimester 2.

> [!tip] Jebakan #5 — **Tidak melakukan pemeriksaan spekulum lalu memberikan diagnosis hanya dari anamnesis**
...
## Balik ke Kasus Bu Rini dan Ani
...
- Pasangan (suami): Ceftriaxone 250 mg IM + Azithromycin 1 gram oral + Doxycycline 100 mg 2×/hari × 7 hari
- Tes HIV dan VDRL: hasil negatif
- **Anjuran:** abstinensia 7 hari, kontrol 2 minggu lagi
...
> Kedua pasien pulang dengan edukasi tentang IMS dan diingatkan kontrol jika keluhan tidak membaik dalam 3 hari.
