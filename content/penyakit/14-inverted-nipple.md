...
> Dokter umum harus bisa mendiagnosis, mengklasifikasikan derajat inverted nipple, membedakan inversi kongenital dari retraksi patologis akibat Ca mamae, serta memberikan tata laksana awal — termasuk edukasi, teknik koreksi non-bedah, dan rujukan tepat.
...
### 1. Inverted Nipple Kongenital (Bawaan)

- Sudah ada sejak lahir — seringkali bilateral
- Disebabkan oleh **duktus laktiferus yang pendek** dan **fibrosis jaringan ikat periduktal** yang menarik puting ke dalam
- Dapat memburuk saat pubertas, kehamilan, atau menyusui
- Tidak ada massa atau keganasan di belakangnya
- Terjadi pada **1-10% populasi** — cukup sering ditemukan di klinik sehari-hari

### 2. Inverted Nipple Didapat (Akuisita / Patologis)

- Sebelumnya normal, lalu **timbul dalam beberapa minggu hingga bulan**
- Hampir selalu **unilateral** — tanda bahaya hingga terbukti bukan
- Disebabkan oleh proses patologis di belakang puting:
  - **Karsinoma mammae** (penyebab tersering — terutama pada > 40 tahun)
  - Mastitis kronis / abses subareolar rekuren
  - Ektasia duktus
  - Pasca-trauma / pasca-operasi payudara
  - TB payudara
  - Lipodistrofi / perubahan jaringan pasca radiasi
- **WAJIB dieksklusi keganasan** sebelum ditentukan sebagai kondisi jinak
...
- **Inverted nipple kongenital:** 1-10% populasi umum, tidak ada predileksi ras. Sering bilateral (70-80% kasus), kadang familial.
- **Inverted nipple didapat:** Data pasti tidak tersedia, tetapi penyebab tersering adalah **Ca mamae** — dan retraksi puting ditemukan pada **5-10% pasien kanker payudara** sebagai gejala pertama atau satu-satunya.
- Pada perempuan hamil dan menyusui, inverted nipple (kongenital maupun yang memburuk saat hamil) menjadi **penyebab tersering kesulitan menyusui** — 10-25% ibu dengan puting rata/inverted melaporkan masalah perlekatan.

---

## Klasifikasi Inverted Nipple (Han & Hong / Modified)
...
Pada inverted nipple kongenital, terdapat **kombinasi tiga faktor anatomis**:

1. **Duktus laktiferus pendek** — saluran susu tidak cukup panjang untuk mencapai permukaan
2. **Fibrosis periduktal** — jaringan ikat fibrosa di sekeliling duktus yang menarik puting ke dalam
3. **Hipoplasia jaringan areolar** — otot polos areolar (sirkular dan radial) yang tidak berkembang sempurna, sehingga tidak mampu "mendorong" puting keluar

Ketiga faktor ini bersama-sama menciptakan **traksi ke arah dalam** yang mengalahkan **ekspansi ke arah luar**, sehingga puting tetap terbenam.
...
> [!warning] **Patofisiologi yang berbeda = penanganan yang berbeda.** Grade 3 kongenital adalah masalah estetika/fungsional — grade 3 didapat adalah masalah onkologi sampai terbukti bukan.
...
1. **Tes tekanan areolar (tes Hood)**: Tekan areola dari kedua sisi dengan ibu jari dan telunjuk — puting normal akan menonjol keluar
2. **Tes traksi**: Tarik puting perlahan dengan ibu jari dan telunjuk — nilai apakah bisa keluar, seberapa mudah, dan apakah bertahan
3. **Tes hisapan (spuit)**: Gunakan spuit 10 mL — potong ujung spuit pada sisi piston, tempelkan ujung yang dipotong ke areola, tarik piston. Nilai apakah puting dapat dikeluarkan

Hasil dari tes ini menentukan **derajat 1, 2, atau 3**.

### Palpasi (Posisi Duduk + Berbaring)

1. **Palpasi areola dan daerah retroareolar** — **ini yang paling penting** pada kasus inverted nipple
2. Palpasi dengan 3 jari tengah, tekanan ringan-sedang-kuat
3. Cari **massa retroareolar**: keras, tidak nyeri, fiksasi? → curiga Ca mamae
4. **Palpasi seluruh kuadran payudara** secara sistematis
5. **Palpasi aksila bilateral** — cari pembesaran KGB
...
1. **Tentukan etiologi** — kongenital vs didapat — ini menentukan seluruh langkah berikutnya
2. **Jika didapat → rujuk onkologi** — jangan lakukan koreksi bedah kosmetik sebelum keganasan dieksklusi
3. **Jika kongenital → tatalaksana berdasarkan derajat dan keluhan**

### Algoritma Tatalaksana Inverted Nipple Kongenital

```
Inverted Nipple Kongenital
        │
        ▼
┌─────────────────────────────┐
│      Tanyakan:              │
...
└─────────────┬───────────────┘
 ...
 Keluhan           Keluhan
  ...
  + Observasi          │
         ...
         ┌────────┴───┐       ▼
         ▼            ▼    Rujuk Bedah
     Non-Bedah    Jika       Plastik
     (sukses)    Gagal       (koreksi
                  │          definitif)
                  ▼
              Rujuk Bedah
              Plastik
...
#### Tata Laksana Non-Bedah (Grade 1-2)

Teknik koreksi non-bedah ditujukan untuk **meregangkan duktus laktiferus yang pendek** dan mengurangi fibrosis:

1. **Teknik Hoffman (manual stretching)**:
   - Letakkan kedua ibu jari di kedua sisi pangkal puting (pada areola)
   - Tekan ke arah luar (menjauhi puting) dengan gerakan meregang
   - Lakukan 2-3 kali sehari, masing-masing 5 menit
   - Tujuan: meregangkan duktus dan melemaskan fibrosis periduktal

2. **Nipple Former / Breast Shell (cangkang puting)**:
   - Alat plastik berbentuk cangkang yang diletakkan di dalam bra
   - Menciptakan tekanan konstan ringan pada areola → mendorong puting keluar
   - Dipakai 2-6 jam per hari — mulai bertahap
   - Aman digunakan selama kehamilan (trimester 3) dan menyusui
...
4. **Spuit 10 mL (teknik hisapan sederhana)**:
   - Potong ujung spuit pada sisi 0 mL (bagian piston)
   - Tempelkan potongan spuit ke areola, tarik piston
   - Diamkan 5-10 menit, lepaskan
   - Lakukan sebelum tiap sesi menyusui

5. **Nipple Shield (pelindung puting)**:
   - Gunakan **sementara** saat menyusui untuk membantu perlekatan
   - Peringatan: nipple shield dapat mengurangi transfer ASI dan stimulasi produksi
...
- **Pada yang tidak ingin menyusui lagi:** Eksisi duktus total + koreksi — rekurensi rendah

> [!warning] **PERINGATAN KRITIKAL:**
> **Jangan lakukan koreksi bedah pada inverted nipple yang didapat (patologis) sebelum keganasan dieksklusi secara tuntas.** Memotong atau membebaskan duktus pada Ca mamae akan mengganggu anatomi tumor dan menyebarkan sel ganas. **PASTIKAN ONKOLOGI CLEARANCE dulu.**

### Tata Laksana pada Kasus Didapat (Patologis)

Jika inverted/retraksi disebabkan oleh Ca mamae → tata laksana **mengikuti tata laksana kanker payudara**:

- Stadium I-II: Operasi (mastektomi / BCS) + adjuvan sesuai protokol
- Stadium III: Neo-adjuvan + operasi + radiasi
- Stadium IV: Paliatif sistemik
- Inverted nipple pada konteks ini **bukan target terapi tersendiri** — akan membaik atau menghilang setelah tumor primer diterapi
...
> [!warning] Jebakan #1 — **Menyamakan semua "puting terbenam" sebagai inverted nipple kongenital**
> Ini adalah **jebakan paling berbahaya**. Setiap retraksi puting yang baru timbul, terutama unilateral pada usia > 40 tahun, adalah **Ca mamae sampai terbukti bukan**. Bedakan onset, lateralisasi, dan ada/tidaknya massa.

> [!tip] Jebakan #2 — **Langsung menyarankan operasi koreksi tanpa mencoba non-bedah dulu**
> Grade 1-2 inverted nipple kongenital sering bisa diatasi dengan teknik non-bedah sederhana (Hoffman, spuit, nipple former). Operasi seharusnya menjadi **pilihan terakhir** — dan hanya jika keluhan benar-benar mengganggu.

> [!warning] Jebakan #3 — **Melakukan koreksi bedah tanpa eksklusi keganasan**
> Jika pasien datang dengan inverted nipple unilateral baru timbul dan Anda langsung merujuk ke bedah plastik untuk koreksi — tanpa mamografi, tanpa USG — dan ternyata itu Ca mamae, maka Anda telah **kehilangan kesempatan diagnosis dini**. Jangan biarkan ini terjadi.

> [!tip] Jebakan #4 — **Menganggap semua inverted nipple pasti menyebabkan masalah menyusui**
> Banyak ibu dengan inverted nipple grade 1 bahkan grade 2 berhasil menyusui secara eksklusif. Kuncinya adalah teknik, dukungan, dan kesabaran. Edukasi antenatal dan konseling laktasi sangat membantu. Jangan menakut-nakuti pasien.

> [!tip] Jebakan #5 — **Menganjurkan nipple shield sebagai solusi jangka panjang**
> Nipple shield memang membantu latch, tetapi pemakaian jangka panjang dapat menurunkan transfer ASI dan stimulasi produksi. Gunakan hanya sementara sambil melatih teknik perlekatan yang benar. Rujuk segera ke konselor laktasi.

> [!warning] Jebakan #6 — **Melewatkan diagnosis Paget's disease pada puting yang "eksim"**
> Eksim puting unilateral yang tidak sembuh dengan steroid jangan dianggap dermatitis biasa. Biopsi kulit puting untuk sel Paget adalah langkah wajib. **Semua eksim unilateral puting adalah Paget sampai terbukti bukan.**

---

## Balik ke Kasus Bu Rina dan Bu Tuti
...
> [!warning] **Pelajaran penting:** Dua pasien, dua puting yang terbenam — tetapi Bu Tuti selamat karena diagnosis ditegakkan tepat waktu. Jika Bu Tuti hanya diberi "teknik Hoffman" tanpa pencitraan — kanker akan terlewat. **Setiap retraksi puting baru = curiga Ca mamae sampai terbukti bukan.**

---

## Pencegahan

### Pencegahan Primer (Inverted Nipple Kongenital)

- Tidak bisa dicegah — ini adalah variasi anatomis kongenital
- Yang bisa dilakukan: **deteksi dini antenatal** — periksa bentuk puting saat ANC (kunjungan kehamilan)
- Edukasi ibu hamil dengan inverted nipple tentang teknik menyusui **sejak trimester 3**
- Anjurkan penggunaan nipple former / breast shell pada trimester 3 (dengan konsultasi dokter)

### Pencegahan Sekunder (Deteksi Dini Masalah)

- Pada ibu hamil dengan inverted nipple: rujuk ke konselor laktasi **sebelum melahirkan**
- Latih teknik Hoffman sejak hamil untuk grade 1-2
- Pantau berat badan bayi lebih ketat dalam 2 minggu pertama — deteksi dini gagal menyusui
...
Inverted nipple kongenital bukanlah faktor risiko Ca mamae — tetapi **setiap perubahan baru pada puting adalah sinyal yang perlu diwaspadai**.
...
> [!tip] **Pesan untuk pasien:** "Ibu, puting terbenam sejak kecil itu umum dan biasanya tidak berbahaya. Tapi kalau puting yang tadinya normal tiba-tiba 'mendekam' ke dalam, terutama pada satu sisi — segera periksakan ke dokter, ya."
