...
aliases:
  ...
  - "Rahim Tidak Mengecil"
  - "Involusi Uterus Lambat"
  - "Subinvolusi Uterus"
  - "rahim tidak mengecil"
  - "subinvolusi"
  - "rahim besar setelah melahirkan"
cssclasses:
  - buku-saku
---
...
> Pada hari ke-5 postpartum, TFU seharusnya sudah **5 jari di bawah pusat** (≈ pertengahan pusat–simfisis). Temuan TFU **2 jari di atas pusat** berarti uterus hanya turun ± 7 jari lebih rendah dari yang seharusnya — ini adalah **keterlambatan involusi berat**. Lochia rubra yang masih menetap di hari ke-5 memperkuat kecurigaan subinvolusi. Jangan tunda evaluasi — lakukan USG untuk menyingkirkan RPOC dan infeksi!

---

## Definisi

**Subinvolusio uteri** adalah kegagalan uterus untuk kembali ke ukuran dan kondisi pra-hamil sesuai dengan kecepatan involusi normal setelah persalinan. Secara klinis, subinvolusi ditegakkan bila **TFU tidak turun sesuai jadwal** — pada hari ke-5 postpartum, fundus masih teraba > 2 jari di bawah pusat (atau bahkan di atas pusat).
...
ADEKUAT     INADEKUAT
    │         │
    ▼         ▼
Sinus vena   Sinus vena tetap
terkompresi  terbuka
→ involusi   │
  normal     ├── RPOC → trauma mekanik menghambat kontraksi
             ├── Infeksi → edema + infiltrat → kontraksi lemah
             ├── Mioma → area non-kontraktil di miometrium
             └── Multiparitas → degenerasi otot → kontraksi lemah
                         │
                         ▼
                  SUBINVOLUSI UTERI
                  TFU tidak turun sesuai jadwal
                  Lochia rubra menetap
                         │
                         ▼
                  Risiko perdarahan postpartum
                  sekunder + endometritis
```

**Mekanisme dasar:** Involusi uterus bergantung pada kontraksi miometrium yang teratur dan progresif. Setiap faktor yang mengganggu kemampuan miometrium untuk berkontraksi — baik mekanik (RPOC, mioma), inflamasi (endometritis), atau degeneratif (grandemultipara) — akan memperlambat proses involusi.

---

## Anamnesis / Gejala

Lakukan anamnesis sistematis — gejala subinvolusi sering tidak khas:

- **Perut masih besar** — keluhan paling umum, seperti masih hamil 4–5 bulan
- **Lochia rubra menetap > 7 hari** — atau tiba-tiba kembali merah setelah sempat membaik
- **Nyeri perut bawah** — ringan hingga sedang; nyeri hebat → endometritis berat
- **Demam / menggigil** — subfebris (37,5–38°C) atau demam tinggi bila infeksi
- **Lemah, lesu** — akibat kehilangan darah subakut dan/atau infeksi
- **Bau lochia** — busuk? Curiga infeksi anaerob
- **Gumpalan darah besar** — curiga RPOC atau perdarahan sekunder
...
1. **TFU tidak turun sesuai jadwal involusi normal** — pada hari ke-5 postpartum, fundus masih teraba > 2 jari di atas pusat (standar emas: klinis)
2. **Lochia rubra menetap > 7 hari** — atau lochia kembali merah setelah sempat berubah ke sanguinolenta/serosa
3. **Uterus teraba lebih besar dan lebih lembek** dari yang seharusnya pada usia postpartum yang sama
4. **Tidak ada penyebab lain** yang bisa menjelaskan TFU tinggi (kandung kemih penuh sudah dieksklusi)
5. **USG** mengonfirmasi ukuran uterus > normal postpartum atau ditemukan RPOC
...
> Dokter umum harus mampu melakukan **tatalaksana awal** subinvolusi uteri — pemberian uterotonika, antibiotik empiris, dan evaluasi USG — **di bawah supervisi SpOG**. Bila ditemukan sisa plasenta (RPOC) pada USG, pasien harus **dirujuk ke SpOG** untuk evakuasi (kuretase). Bila perdarahan aktif masif atau sepsis, aktivasi **tim CODE RED** dan rujuk segera.
...
>
> **Efek samping ergometrin:** mual, muntah, sakit kepala, hipertensi berat, vasospasme koroner. Jangan memberikan ergometrin IV bolus cepat — berikan IM atau IV lambat.
...
1. **Menganggap TFU tinggi hanya karena kandung kemih penuh:** Anda kateterisasi, TFU tetap tinggi. **Evaluasi TFU setelah kandung kemih kosong, tapi jangan berhenti — dokumentasikan secara serial.**

2. **Membedakan subinvolusi dari RPOC tanpa USG:** Tanpa USG, Anda tidak bisa memastikan apakah sisa plasenta ada. **USG adalah langkah WAJIB pada setiap kasus subinvolusi — jangan beri uterotonika saja tanpa USG.**
...
>
> Dengan tiga langkah ini, Anda sudah bisa membedakan subinvolusi sederhana, RPOC, dan endometritis — dan menentukan apakah perlu rujukan.
...
- **Suhu 37,8°C** — demam ringan, curiga infeksi subklinis
- **Kandung kemih kosong** — sudah dikonfirmasi
...
4. **Kontrol** — Kembali dalam 3 hari untuk evaluasi TFU + lochia + respons terapi. Bila demam meningkat, lochia berbau busuk, atau perdarahan membanyak → segera ke IGD

> [!warning] **Peringatan untuk Ny. Ratna**
> Meskipun USG saat ini tidak menunjukkan RPOC, subinvolusi yang disertai demam subfebris meningkatkan risiko endometritis. Jika dalam 48–72 jam TFU tidak turun signifikan atau demam meninggi, **ulangi USG dan rujuk ke SpOG** untuk evaluasi lebih lanjut. Jangan menunda rujukan bila ada perburukan!

---

## Ringkasan untuk Dokter Umum

1. **Subinvolusi uteri** = kegagalan uterus mengecil sesuai jadwal — TFU di hari ke-5 masih > 2 jari di atas pusat.
2. **Aturan "1 jari per hari"** — fundus turun 1 jari setiap hari postpartum. Di hari ke-5, fundus seharusnya 5 jari di bawah pusat.
