...
> Dokter umum harus mampu mendiagnosis dan **tuntas menangani sendiri** kasus aborsi spontan komplit — termasuk mengenali tanda-tanda abortus komplit, memastikan tidak ada sisa jaringan intrauterin, memberikan konseling pasca-keguguran, serta mengenali kapan diperlukan rujukan untuk evakuasi sisa jaringan atau penanganan komplikasi.
...
**Aborsi spontan komplit** adalah pengeluaran **seluruh hasil konsepsi** (janin, plasenta, dan membran) dari kavum uteri secara spontan sebelum usia kehamilan 20 minggu (atau berat janin < 500 gram) tanpa intervensi medis, dan telah dipastikan **tidak ada sisa jaringan** yang tertinggal di dalam rongga rahim.

Abortus komplit merupakan **salah satu tahapan akhir** dari proses abortus yang diawali dengan perdarahan dan kontraksi uterus hingga seluruh jaringan keluar. Pada titik ini, perdarahan sudah berkurang signifikan, serviks sudah menutup (atau hanya sedikit terbuka), dan osteum uteri internum telah tertutup kembali.

> [!tip] **Abortus Komplit vs Inkomplit — Kata Kuncinya**
> Pada abortus **komplit**, ostium uteri sudah **menutup** dan kavum uteri **kosong**. Pasien biasanya merasa "sesuatu telah lepas" atau melihat jaringan keluar, lalu nyeri dan perdarahan mereda. Pada abortus **inkomplit**, ostium masih terbuka dan masih ada sisa jaringan — perdarahan masih aktif atau terus-menerus.
...
1. **Usia ibu** — risiko abortus meningkat progresif: 15% pada usia 20–30 tahun, 20–35% pada usia 35–40 tahun, > 50% pada usia > 45 tahun
2. **Riwayat abortus sebelumnya** — setelah 1 abortus risiko 15%, setelah 2 abortus risiko 25–30%, setelah ≥ 3 abortus (habitual) risiko 40–50%
3. **Indeks massa tubuh** — obesitas (IMT > 30) meningkatkan risiko 1,5–2×
4. **Merokok** — peningkatan risiko 1,2–1,5×, bersifat dose-dependent
5. **Alkohol dan kafein berlebih** — konsumsi > 300 mg kafein/hari meningkatkan risiko
6. **Penyakit sistemik** — DM tidak terkontrol, penyakit tiroid, penyakit autoimun

> [!warning] **Penyebab Kromosom = Paling Sering, Bukan Salah Ibu**
> Edukasi pasien: "Keguguran di trimester pertama BUKAN karena Anda salah jalan, salah makan, atau terlalu capek. Pada lebih dari setengah kasus, penyebabnya adalah kelainan kromosom yang terjadi secara acak — tidak bisa dicegah dan bukan kesalahan siapa pun." Ini penting untuk **mengurangi rasa bersalah** yang sering menghantui pasien pasca-keguguran.

---

## Klasifikasi Aborsi

Untuk memahami aborsi komplit, kita harus memahami **spektrum aborsi spontan** secara keseluruhan:
...
### Trias Klasik Abortus Komplit

1. **Perdarahan pervaginam** — dimulai dari flek, lalu membanyak seperti haid, kemudian keluar gumpalan darah besar
2. **Nyeri perut bawah** — berupa mulas/kontraksi yang meningkat intensitasnya seiring perdarahan
...
1. **HPHT (Hari Pertama Haid Terakhir)** — tentukan usia kehamilan saat abortus
2. **Kapan tes kehamilan terakhir positif?** — konfirmasi kehamilan sebelumnya
...
10. **Riwayat abortus dan persalinan sebelumnya** — gravida, para, jumlah keguguran

> [!warning] **Red Flag — Abortus Provokatus (Aborsi Tidak Aman)**
> Jika pasien mengaku ada upaya menggugurkan kehamilan dengan obat/jamu/prosedur tertentu, atau jaringan berbau busuk, atau ada demam tinggi + perdarahan hebat → **rujuk segera**. Abortus septik/terinfeksi adalah kegawatdaruratan obstetri yang memerlukan antibiotik intravena dan evakuasi di rumah sakit dengan fasilitas lengkap.
...
### Pemeriksaan Jaringan yang Dikeluarkan

Jika pasien membawa jaringan yang dikeluarkan, lakukan:

1. **Inspeksi makroskopis:** Cari villi korialis (jaringan berjonjot seperti karang) — ini memastikan jaringan berasal dari kehamilan intrauterin
2. **Float test:** Masukkan jaringan dalam air — villi korialis akan mengapung
3. **Patologi anatomi:** Kirim ke PA jika ragu atau curiga mola hidatidosa (vesikel seperti anggur)

> [!warning] **Jika Jaringan Tidak Ditemukan — Pikirkan Kehamilan Ektopik!**
> Pasien dengan tes kehamilan positif + perdarahan + nyeri perut, tetapi **tidak ada villi korialis** pada jaringan yang keluar — curigai **kehamilan ektopik terganggu (KET)** sampai terbukti lain. USG adneksa dan β-hCG serial sangat penting pada kasus ini.

---

## Diagnosis

### Kriteria Diagnosis Aborsi Spontan Komplit

Diagnosis abortus komplit ditegakkan berdasarkan **anamnesis + pemeriksaan fisik + USG**:

#### Kriteria Klinis (Jika USG Tidak Tersedia)
...
1. Kavum uteri **kosong** — tidak ada kantong gestasi atau sisa jaringan
2. Tebal endometrium < 5 mm (transvaginal)
3. Tidak ada tanda-tanda kehamilan intrauterin atau ekstrauterin

### Algoritma Diagnosis

```flowchart
Pasien dengan perdarahan pervaginam + nyeri perut + usia kehamilan < 20 minggu
                          │
                          ▼
                    Anamnesis + Tes Kehamilan (+)
                          │
                          ▼
              Pemeriksaan Obstetri (VT/Spekulum)
                          │
        ┌─────────────────┼─────────────────┐
        ▼                 ▼                 ▼
   Ostium       Ostium terbuka       Ostium menutup
   tertutup     + jaringan ada       + jaringan keluar
   jaringan                  │                 │
   belum keluar              ▼                 ▼
        │           Abortus              Abortus
        ▼           Inkomplit            Komplit
...
> |--------|-----------|----------|-----------|
> | Tertutup | Flek | Belum keluar | **Imminens** |
> | Terbuka | Aktif | Belum keluar | **Insipiens** |
> | Terbuka | Aktif | Sebagian keluar | **Inkomplit** |
> | **Menutup** | **Minimal** | **Sudah keluar semua** | **→ Komplit** |
...
1. **Konfirmasi diagnosis** — pastikan benar-benar abortus komplit (kavum uteri kosong) sebelum memutuskan tidak melakukan evakuasi
2. **Jika ragu → lakukan USG** — jangan hanya andalkan anamnesis dan VT
3. **Pada abortus komplit yang sudah pasti: tidak perlu kuretase** — evakuasi hanya jika ada sisa jaringan (inkomplit)
4. **Tangani anemia** — jika perdarahan banyak sebelumnya, periksa HB dan beri suplemen zat besi
5. **Cegah infeksi** — antibiotik profilaksis tidak rutin, hanya jika ada faktor risiko infeksi (abortus septik, riwayat manipulasi, jaringan berbau)
6. **Konseling** — dukungan emosional, edukasi penyebab keguguran, dan kapan boleh hamil lagi
7. **Rujuk** — jika perdarahan masih aktif, ragu diagnosis, ada tanda-tanda syok, atau ada komplikasi
...
> **Tidak perlu kuretase.** Cukup observasi dan tatalaksana konservatif.
...
- Alternatif: **rujuk** ke fasilitas dengan USG atau dokter spesialis obgyn
...
1. **Penyebab keguguran:** Jelaskan dengan empati. Pada trimester I, > 50% karena kelainan kromosom acak — bukan karena kesalahan ibu
2. **Pantau hCG:** Tes kehamilan urine biasanya negatif dalam 2–4 minggu. Jika masih positif > 4 minggu → curigai sisa jaringan atau mola
3. **Haid kembali:** Biasanya dalam 4–6 minggu. Jika belum haid > 8 minggu → evaluasi
4. **Kapan boleh hamil lagi:** Tunggu **minimal 1 siklus haid normal** (2–3 bulan) sebelum mencoba hamil lagi untuk memberi waktu endometrium regenerasi. Beberapa penelitian terbaru mengatakan tidak perlu menunggu lama jika ibu sehat, tapi konsensus Indonesia tetap menganjurkan 3 bulan
5. **Kontrasepsi:** Pasien bisa menggunakan kontrasepsi apapun segera setelah abortus komplit, termasuk IUD (dapat dipasang segera jika sudah yakin tidak ada infeksi)
6. **Asam folat** — lanjutkan asam folat 400 mcg/hari untuk persiapan kehamilan berikutnya
...
> [!tip] **Jebakan #1 — Langsung kuret tanpa USG**
> Jangan kuret semua pasien abortus hanya karena ada riwayat perdarahan. **Pastikan dulu masih ada sisa jaringan.** Jika kavum kosong (abortus komplit), kuretase adalah malpraktik — menyebabkan sinekia, infertilitas, dan komplikasi yang tidak perlu. USG transvaginal dapat menyelamatkan Anda dari keputusan yang keliru.

> [!tip] **Jebakan #2 — VT yang salah interpretasi**
> Ostium uteri yang sudah menutup bukan berarti pasti abortus komplit — missed abortion juga punya ostium tertutup. Bedanya: missed abortion tidak ada riwayat jaringan keluar dan USG menunjukkan janin mati intrauterin. **Korelasi anamnesis + VT + USG sangat penting.**

> [!tip] **Jebakan #3 — Mengira abortus inkomplit sebagai komplit karena perdarahan sudah berkurang**
> Perdarahan bisa berkurang sementara jika gumpalan darah menyumbat ostium, padahal masih ada sisa jaringan di atasnya. Ini jebakan berbahaya! Lakukan USG atau serial hCG untuk memastikan kavum uteri benar-benar kosong. Jangan tertipu oleh "perbaikan palsu."

> [!tip] **Jebakan #4 — Tidak memberi Anti-D pada ibu Rh negatif**
...
> [!tip] **Jebakan #7 — Lupa eksklusi kehamilan ektopik**
> Setiap pasien dengan tes kehamilan positif + perdarahan pervaginam + jaringan yang keluar → pastikan itu benar-benar villi korialis (kehamilan intrauterin). Jika tidak ada villi atau ragu → lakukan USG dan β-hCG serial untuk menyingkirkan **kehamilan ektopik terganggu**, yang juga bisa bermanifestasi seperti abortus namun mematikan.

---

## Balik ke Kasus Ny. Amanda
...
> **Aborsi Spontan Komplit** (usia kehamilan ±14 minggu) pada G2P1A1 dengan anemia ringan dan Rh negatif.

### Tatalaksana pada Ny. Amanda

1. **Konfirmasi abortus komplit** — USG menunjukkan kavum uteri kosong, endometrium 4 mm. **Tidak perlu kuretase.**
2. **Anti-D IgG (RhoGam)** — 50 mcg IM segera karena Rh negatif (dalam 72 jam). Hitung dosis: 50 mcg cukup untuk abortus < 20 minggu.
3. **Suplemen zat besi** — Fe sulfat 1×60 mg/hari + asam folat 1×400 mcg/hari selama 2 bulan
4. **Edukasi:**
   - Darah sisa (lochia) bisa keluar 3–7 hari — gunakan pembalut
...
Seminggu kemudian, Ny. Amanda kontrol:

- Perdarahan sudah berhenti total
- Tidak demam, tidak nyeri
- Test pack urine: **negatif** — mengonfirmasi abortus komplit tanpa sisa jaringan
...
## Pencegahan Aborsi Spontan Berulang
...
1. **Istirahat yang cukup** — fisik dan emosional
2. **Nutrisi adekuat** — tinggi protein, zat besi, dan asam folat
3. **Asam folat** — 400–1000 mcg/hari untuk kehamilan berikutnya
4. **Kontrol penyakit sistemik** — DM, tiroid, hipertensi
5. **Vaksinasi** — rubella, hepatitis B, TT/Td sebelum hamil lagi
6. **Berikan jarak kehamilan** — minimal 1 siklus haid (2–3 bulan)
7. **Periksa ANC rutin** segera setelah hamil lagi

---

## Ringkasan untuk Koas

1. **Abortus komplit = seluruh hasil konsepsi sudah keluar, kavum uteri kosong.** Diagnosis ditegakkan dengan: anamnesis (jaringan keluar → nyeri mereda → perdarahan berkurang) + VT (ostium menutup) + USG (kavum kosong).
2. **Tidak perlu kuretase** pada abortus komplit yang sudah terkonfirmasi. Kuretase hanya untuk abortus inkomplit.
3. **Jangan tertukar dengan abortus inkomplit.** Periksa dengan VT dan USG. Jika ragu, anggap sebagai inkomplit sampai terbukti sebaliknya.
4. **Jika jaringan tidak ditemukan** → pikirkan kehamilan ektopik terganggu (KET).
5. **Jangan lupa anti-D** pada ibu Rh negatif — ini adalah standar medikolegal.
6. **Konseling sangat penting:** yakinkan bahwa ini bukan kesalahan ibu, validasi perasaan kehilangannya, dan beri panduan kapan boleh hamil lagi.
7. **Cari penyebab abortus** untuk mencegah berulang: usia lanjut, kelainan anatomis, endokrin, autoimun, infeksi.
8. **Rujuk ke obgyn** jika: abortus habitualis (≥ 3×), perdarahan hebat, syok, demam (abortus septik), ragu diagnosis, atau ada kelainan anatomi/sistemik yang perlu tatalaksana lanjut.

> [!warning] **Ingat — Abortus Komplit Bukan Akhir dari Segalanya**
> Sebagian besar wanita yang mengalami abortus komplit akan hamil lagi dan melahirkan bayi sehat. Satu kali keguguran tidak memengaruhi fertilitas atau prognosis kehamilan berikutnya. Dukungan Anda sebagai dokter — medis dan emosional — sangat berarti bagi pasien yang sedang berduka.
