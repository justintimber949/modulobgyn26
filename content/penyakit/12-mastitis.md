...
aliases:
  ...
  - "Infeksi Payudara Menyusui"
  - "Mastitis Puerperalis"
  - "Mastitis Periduktal"
  - "radang payudara"
  - "payudara bengkak panas"
  - "mastitis menyusui"
  - "payudara keras"
cssclasses:
  - buku-saku
...
> Dokter umum harus bisa mendiagnosis dan **tuntas menangani sendiri** mastitis laktasional stadium dini — termasuk terapi antibiotik, konseling laktasi, dan identifikasi dini tanda abses yang memerlukan rujukan.
...
> [!warning] Mastitis laktasional terjadi pada **1-33% ibu menyusui** di seluruh dunia. Di Indonesia, angka kejadian diperkirakan 6-10% pada ibu nifas. Sebagian besar terjadi dalam **6 minggu pertama** postpartum. Mastitis non-laktasional lebih jarang — sekitar 5-10% dari seluruh kasus mastitis.

### Mengapa Ini Penting

- Mastitis yang tidak ditangani adekuat dapat berkembang menjadi **abses payudara** yang memerlukan drainase bedah
- Dapat menyebabkan **penghentian menyusui dini** (premature weaning) — padahal ASI eksklusif sangat dianjurkan
- Salah diagnosis dengan Ca mamae dapat menimbulkan kecemasan berlebih atau keterlambatan penanganan keganasan
- Mastitis rekuren bisa menjadi tanda **ektasia duktus** atau kelainan anatomis payudara
...
1. **Status laktasi** — sedang menyusui? Kapan terakhir menyusui dari payudara sakit?
2. **Gejala sistemik** — demam, menggigil, nyeri seluruh tubuh
3. **Riwayat puting lecet / trauma** — retak, lecet, atau blister pada puting
4. **Riwayat mastitis sebelumnya** — pada kehamilan sebelumnya atau laktasi sebelumnya
5. **Faktor risiko non-laktasional** — merokok, diabetes, imunokompromais, terapi steroid jangka panjang
6. **Riwayat duh puting** — warna, konsistensi, jumlah, satu pori atau multipori
7. **Keluhan payudara kontralateral** — apakah kedua payudara terkena?
...
> - **Darah dari puting** → eksklusi karsinoma intraduktal / papiloma intraduktal
> - **Mastitis bilateral simetris** → pertimbangkan penyakit sistemik (TB payudara, sarkoidosis, granulomatosa)
> - **Mastitis rekuren** pada non-laktasional → rujuk untuk biopsi eksklusi keganasan
...
1. Palpasi bertahap menggunakan **3 jari tengah** dengan tekanan ringan-sedang-kuat
2. Lakukan sistematis dari **kuadran luar atas** → bawah → dalam → bawah → dalam atas (**metode kuadran**)
3. Catat: lokasi, ukuran, konsistensi, mobilitas, nyeri tekan, fluktuasi
4. **Palpasi aksila** — cari limfadenopati (pembesaran KGB aksila ipsilateral sering ditemukan pada mastitis berat)
5. **Tes fluktuasi** — raba daerah yang paling menonjol dengan dua jari: terasa gerakan **gelombang cairan**? Jika ya → abses payudara
...
1. **Keluarkan ASI secara efektif** — ini adalah langkah **paling penting** (mengatasi stasis)
2. **Antibiotik** — jika ada tanda infeksi (demam sistemik, eritema luas, purulen)
3. **Terapi suportif** — analgesik, kompres, hidrasi
4. **Jangan hentikan menyusui** — justru lanjutkan atau pompa dari payudara sakit
5. **Edukasi dan dukungan** — cegah premature weaning

### Tatalaksana Mastitis Laktasional
...
- **Pijat lembut** payudara dari area yang bengkak ke arah puting saat menyusui atau memompa
- **Hidrasi dan istirahat** yang cukup
- **Analgesik:** Paracetamol 500-1000 mg tiap 6 jam (aman untuk laktasi) — atau Ibuprofen 400 mg tiap 8 jam (anti-inflamasi lebih baik)

> [!tip] Jebakan: Jangan hentikan menyusui dari payudara yang sakit! ASI tetap aman dan justru membantu mengatasi stasis. Bayi mungkin rewel karena rasa ASI yang lebih asin (↑ natrium), tetapi tetap boleh dan aman. **Menghentikan menyusui justru memperburuk stasis → abses.**

#### Tahap 2 — Farmakologis (mastitis dengan demam / gejala sistemik)
...
- **Evaluasi 48 jam:** demam turun? Eritema berkurang? Jika tidak membaik → curigai abses atau bakteri resisten → USG payudara + kultur ASI
- **Lama antibiotik:** minimal 7-10 hari — jangan hentikan meski gejala sudah hilang
- **Jika membaik:** lanjutkan antibiotik sampai habis, edukasi pentingnya menyusui terus
- **Jika fluktuasi (+):** USG konfirmasi abses → rujuk untuk aspirasi / I&D (insisi & drainase)

### Tatalaksana Mastitis Non-Laktasional

**Pendekatan berbeda karena penyebab dan patofisiologi yang berbeda:**

1. **Antibiotik** — sama dengan laktasional (dikloksasilin/sefaleksin) bila ada tanda infeksi, tetapi durasi biasanya lebih panjang (10-14 hari)
...
> [!warning] Jebakan #3 — **Tertukar dengan karsinoma inflamatorik (IBC)**
...
> [!warning] Jebakan #6 — **Diagnosis Ca mamae terlewat karena mengira semua benjolan adalah mastitis**
> Pada mastitis non-laktasional, terutama pada perempuan > 40 tahun dengan benjolan yang tidak nyeri — **eksklusi Ca mamae wajib hukumnya.** Lakukan mamografi/USG dan jika ragu, biopsi. Jangan sampai Anda melewatkan kanker.

---

## Balik ke Kasus Bu Sari dan Dinda
...
- **Anjuran:** kompres hangat pada areola, hindari penekanan/massa berlebih
- **Kontrol 2 minggu:** jika massa menetap → rujuk untuk biopsi

**Hasil:** Setelah 10 hari antibiotik, eritema dan nyeri menghilang. Ektasia duktus residual masih ada — pasien diedukasi untuk kontrol rutin. Dinda berhenti merokok setelah konseling intensif. Tidak ada rekurensi dalam 6 bulan.
...
6. **Jangan memakai bra terlalu ketat** — aliran ASI terhambat
