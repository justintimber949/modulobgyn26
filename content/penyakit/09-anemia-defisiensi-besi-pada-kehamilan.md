---
title: "Anemia Defisiensi Besi pada Kehamilan"
tags:
  - penyakit
  - obstetri
  - skdi-4a
...
> Dokter umum harus mampu mendiagnosis dan menatalaksana anemia defisiensi besi pada kehamilan secara **mandiri dan tuntas** — termasuk skrining, diagnosis banding, terapi zat besi yang adekuat, edukasi gizi, serta mengenali tanda bahaya yang memerlukan rujukan ke subspesialis.
...
_Ini adalah gambaran klasik anemia defisiensi besi pada kehamilan — salah satu masalah tersering yang akan Anda temui setiap hari di poli antenatal, puskesmas, maupun klinik bersalin._

> [!warning] **Red Flag!** Anemia berat pada kehamilan (Hb < 7 gr/dL) meningkatkan risiko gagal jantung kongestif, syok hipovolemik saat perdarahan, dan kematian maternal. Jangan anggap sepele keluhan lemas pada ibu hamil — skrining laboratorium adalah langkah wajib!

---

## Definisi

**Anemia defisiensi besi (ADB) pada kehamilan** adalah suatu kondisi anemia yang disebabkan oleh menurunnya cadangan besi dalam tubuh, sehingga mengganggu sintesis hemoglobin, yang terjadi pada saat kehamilan. Ini adalah **jenis anemia tersering** pada kehamilan, mencakup sekitar 75–80% dari seluruh kasus anemia pada ibu hamil.
...
## Epidemiologi dan Mengapa Ini Penting

Anemia pada kehamilan merupakan **masalah global** yang mempengaruhi sekitar 37–40% ibu hamil di dunia. Di Indonesia, angka ini lebih tinggi — **48,9% ibu hamil** mengalami anemia (Riskesdas 2018), dengan defisiensi besi sebagai penyebab utama.

**Mengapa ini penting?** Anemia defisiensi besi yang tidak ditangani pada kehamilan dapat menyebabkan:

- **Pada ibu:** Kelelahan berat, penurunan kapasitas kerja, peningkatan risiko perdarahan postpartum, gagal jantung, bahkan kematian maternal
- **Pada janin:** Pertumbuhan janin terhambat (IUGR), berat lahir rendah (BBLR), prematuritas, cadangan besi neonatus yang rendah → anemia pada bayi
- **Pada persalinan:** Intoleransi terhadap perdarahan, inersia uteri, atonia uteri
- **Pada postpartum:** Gangguan produksi ASI, depresi postpartum, mudah infeksi nifas

---

## Etiologi dan Patofisiologi

### Mengapa Ibu Hamil Rentan Anemia Defisiensi Besi?
...
### Faktor Risiko Anemia Defisiensi Besi pada Kehamilan

1. **Asupan besi kurang** — diet rendah daging merah, sayur hijau, atau pola makan vegetarian tanpa perencanaan
...
9. **Sosial ekonomi rendah** — akses terbatas ke makanan bergizi dan suplementasi
...
1. **Keluhan kardinal**: Apakah ada lemas, pusing, atau sesak napas? Kapan dimulai? Apakah memberat dengan aktivitas?
2. **Riwayat perdarahan**: Perdarahan haid sebelum hamil (profus? durasi panjang?), perdarahan awal kehamilan, perdarahan saat persalinan sebelumnya
3. **Riwayat kehamilan**: Gravida, para, jarak kehamilan, riwayat abortus, riwayat perdarahan postpartum
4. **Asupan nutrisi**: Apakah makan daging/lauk hewani? Sayur hijau? Buah? Apakah minum teh/kopi setelah makan (mengganggu absorpsi besi)?
5. **Kepatuhan minum tablet tambah darah**: Apakah rutin? Efek samping? Mual? Sembelit?
6. **Gejala pica**: Apakah ada keinginan makan es batu, tanah, kapur, ampas kopi? — ini sangat khas untuk defisiensi besi!
7. **Riwayat infeksi**: Cacingan, malaria, TB, HIV
8. **Obat-obatan**: Antasida, penghambat pompa proton (mengurangi absorpsi besi)

> [!tip] **Jebakan: Keluhan "lemas" sering dianggap normal kehamilan.** Banyak dokter, bidan, bahkan pasien sendiri menganggap lemas, pusing, dan cepat lelah sebagai hal yang wajar saat hamil. Padahal ini bisa jadi satu-satunya manifestasi anemia! **Jangan lewatkan skrining Hb pada kunjungan ANC pertama, awal trimester 2, dan awal trimester 3 — bahkan pada pasien tanpa keluhan.**
...
### Kriteria Diagnosis Anemia Defisiensi Besi pada Kehamilan

Diagnosis ADB ditegakkan berdasarkan:

1. **Anamnesis** — gejala anemia + faktor risiko + riwayat nutrisi/perdarahan
2. **Hb** — sesuai batas trimester
3. **Indeks eritrosit** — mikrositik hipokromik (MCV < 80 fL, MCH < 27 pg)
4. **Feritin serum** — < 30 ng/mL (gold standard untuk status besi)
5. **Respon terapi** — peningkatan Hb ≥ 1 gr/dL dalam 2–4 minggu setelah suplementasi besi adekuat → konfirmasi diagnosis ADB

### Algoritma Diagnosis

```
Ibu hamil dengan Hb rendah
         │
         ▼
  Hitung indeks eritrosit (MCV, MCH, RDW)
         │
         ├── MCV > 100 fL (makrositik)
         │       └── Curiga defisiensi asam folat / B12 → cek folat serum & B12
         │
         ├── MCV 80–100 fL (normositik)
         │       └── Curiga anemia fisiologis kehamilan / penyakit kronis
         │
         └── MCV < 80 fL (mikrositik)
                 │
                 ├── Cek feritin
                 │      │
                 │      ├── Feritin < 30 ng/mL → ADB
                 │      └── Feritin normal/↑ → curiga talasemia
                 │             └── HbA₂ elektroforesis
                 │
                 ├── RDW ↑ + Mentzer index > 13 → ADB
                 └── RDW normal + Mentzer index < 13 → Talasemia
```
...
1. **Koreksi anemia** — suplementasi besi untuk mencapai Hb normal sesuai trimester
2. **Koreksi penyebab** — obati infeksi (cacing, malaria, TB), perbaiki nutrisi, atasi perdarahan
3. **Edukasi dan kepatuhan** — efek samping suplementasi adalah penyebab utama ketidakpatuhan
4. **Monitoring** — evaluasi Hb 2–4 minggu setelah terapi dimulai
5. **Rujuk** jika Hb < 7 gr/dL atau tidak respons terhadap suplementasi adekuat

### Suplementasi Zat Besi (Terapi Lini Pertama)
...
Ibu hamil dengan **kehamilan ganda** (kembar) membutuhkan suplementasi lebih tinggi: Fe 100–200 mg/hari + asam folat 1000 mcg/hari (1 mg/hari) sepanjang kehamilan.
...
- Ketidakpatuhan terhadap terapi oral
- Kehilangan darah berkelanjutan

**Sediaan yang tersedia:**
| Sediaan | Dosis per infus | Lama pemberian |
|---------|----------------|----------------|
| Iron sucrose (Venofer) | 200 mg dalam 100 mL NaCl 0,9% | 1 jam (infus) |
| Ferric carboxymaltose (Ferinject) | 500–1.000 mg | 15–30 menit (infus cepat) |
| Iron dextran | Dosis berat badan | Uji dosis dulu (risiko anafilaksis) |

> [!warning] **Reaksi anafilaksis** dapat terjadi terutama pada iron dextran (1–2%). Pastikan resusitasi siap. Sediaan iron sucrose dan carboxymaltose memiliki risiko lebih rendah. Hanya berikan di fasilitas yang mampu melakukan resusitasi!
...
- Gagal dengan terapi besi IV

Prinsip transfusi: berikan PRC (packed red cells) 1–2 unit, jangan kejar Hb normal — risiko volume overload. Target Hb 7–8 gr/dL sudah cukup aman untuk persalinan.
...
### 1. Kepatuhan Minum Tablet Tambah Darah (TTD)

Ini adalah **masalah nomor satu** dalam tata laksana ADB. Penelitian di Indonesia menunjukkan > 50% ibu hamil tidak patuh minum TTD.
...
- Setiap kali **ANC** — periksa Hb tiap trimester
- Setelah mulai terapi Fe: periksa ulang **2–4 minggu** (target kenaikan Hb ≥ 1 gr/dL)
- Jika Hb tidak naik dalam 4 minggu meski patuh minum → cari penyebab lain: talasemia, perdarahan tersembunyi, infeksi kronis, malabsorpsi
- Jika Hb turun atau < 7 gr/dL → rujuk ke dokter spesialis obstetri-ginekologi

---

## Pencegahan

### Program Nasional: Tablet Tambah Darah (TTD)
...
4. **Kontrol cacingan** — obat cacing 2×/tahun di daerah endemis

### Jarak Kehamilan

Anjurkan jarak kehamilan **≥ 2 tahun** untuk memulihkan cadangan besi. KB pasca salin adalah momentum edukasi yang baik.
...
> [!tip] **Jebakan #4 — Menganggap kenaikan Hb yang lambat sebagai kegagalan terapi.** Kenaikan Hb yang diharapkan adalah **1 gr/dL per 2–4 minggu** — tidak lebih cepat. Jangan mengubah terapi terlalu dini. Butuh 2–4 minggu untuk melihat respons eritropoiesis yang bermakna.

> [!tip] **Jebakan #5 — Memberi Fe bersamaan dengan antasida/kalsium/susu.** Kalsium, antasida, dan tanin (teh/kopi) mengikat besi dan mengurangi absorpsinya hingga 50%. Beri jeda minimal 1–2 jam.
...
4. **Edukasi kepatuhan**: minum Fe setelah makan malam, feses hitam normal, jangan minum teh/kopi 1 jam sebelum/sesudah Fe
5. **Konsumsi makanan sumber hewani** kaya heme iron + vitamin C
...
> [!warning] **Pesan untuk Bu Susi:** Anemia defisiensi besi pada kehamilan adalah kondisi yang sangat umum dan **sangat bisa diobati**. Kuncinya adalah minum obat teratur setiap hari, makan makanan bergizi, dan kontrol rutin. Jika diabaikan, anemia ini bisa membahayakan ibu dan janin.
...
1. **Skrining Hb adalah WAJIB** — setiap trimester. Jangan menunggu pasien mengeluh lemas.
2. **Gunakan batas trimester** — Hb < 11 (T1/T3), < 10,5 (T2).
3. **Anemia mikrositik hipokromik** → ADB sampai terbukti lain. Cek feritin untuk konfirmasi.
4. **Talassemia carrier** adalah diagnosis banding utama — cek HbA₂ jika tidak responsif terhadap Fe.
5. **Fe oral 60–200 mg/hari + asam folat** adalah terapi utama. Kepatuhan adalah tantangan terbesar.
6. **Edukasi efek samping** — feses hitam normal, minum setelah makan, bagi dosis jika perlu.
7. **Pica (makan es batu)** — tanyakan! Ini sangat khas ADB.
8. **Jangan lupa cari penyebab** — perdarahan, cacingan, malabsorpsi, talasemia.
9. **Rujuk jika Hb < 7 gr/dL** atau gagal terapi oral.
10. **Cegah dengan suplementasi** semua ibu hamil — TTD 90 tablet selama kehamilan.
