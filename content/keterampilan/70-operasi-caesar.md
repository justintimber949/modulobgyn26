...
1. **Informed consent** — indikasi, risiko, alternatif, anestesi
2. **Anestesi:** Spinal (standar elektif/darurat) / Epidural (jika sudah pasang) / Umum (darurat ekstrem, kontraindikasi neuraksial)
3. **Pre-op:** Puasa 6-8 jam, antasida 30 mL (natrium sitrat), antibiotik profilaksis **sefazolin 2 g IV** (30-60 menit sebelum insisi), kateterisasi DC, kompresi pneumatik / heparin LMWH (jika risiko TVP)
4. **Tim:** Operator (SpOG), Asisten 1 (SpOG/Dokter umum terlatih), Anestesi, Instrumenter, Sirkuler, Neonatologi
5. **Alat:** Set SC standar, sutur absorbable 1-0/2-0 (uterus), 2-0/3-0 (fascia), 3-0/4-0 (subkutik/kulit), jarum setengah lingkaran, retractor (Balfour/Deaver), kelly, allis, klem hemostat
...
- **Histerotomi 2 lapis (standar):**
  ...
  - Lapis 2: Continuous imbricating (menutup lapis 1, memperkuat)
...
- Kulit: Subcuticular 3-0/4-0 monofilamen (kosmetik) ATAU stapler

> [!warning] Red Flag
> **Histerotomi vertikal (klasik) → SC berikutnya WAJIB SC elektif 36-37 mg** (risiko ruptur uterus tinggi).
> **Plasenta accreta spectrum** — jika terdeteksi intraop, **JANGAN paksa ambil plasenta**! Pertimbangkan histerektomi atau conservative management (leave placenta in situ + metotreksat/arteri embolization) — butuh tim multidisplin.
> **Perdarahan > 1500 mL** — aktifkan protokol PPH masif (transfusi 1:1:1, kompresi bimanual, tamponade balloon, ligasi arteri uterus/ovarium, histerektomi).
...
1. **Anatomi lapis** hafalkan: Kulit → Subkut → Fascia → Otot (blunt) → Peritoneum → Uterus
2. **Fascia = lapisan KUNCI** penutup — continuous non-locking 1-0/2-0 absorbable
3. **Histerotomi low transverse** = standar; klasik hanya indikasi khusus
4. **Antibiotik profilaksis SEBELUM insisi kulit** (sefazolin 2 g IV)
5. **Delayed cord clamping** 30-60 detik jika janin stabil
6. **Oxytocin 10-20 IU IV infus** pasca plasenta keluar — WAJIB
7. Asisten tugas: retraktur, sediakan jahitan, hitung alat (instrument count 3×!), tekan perdarahan
...
1. POGI. Pedoman Operasi Caesar. 2019
2. WHO. WHO Recommendations for Caesarean Section. 2018
3. ACOG Practice Bulletin No. 205: Vaginal Birth After Cesarean. 2019
4. NICE Guideline NG192: Caesarean Birth. 2021
5. Sarwono Prawirohardjo. Ilmu Kandungan. 2018
6. Kemenkes RI. Standar Pelayanan Operasi Caesar. 2020
