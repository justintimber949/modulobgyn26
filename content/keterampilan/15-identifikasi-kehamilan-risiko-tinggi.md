...
### 2. **Pemeriksaan Fisik Terpadu (Setiap Kunjungan ANC)**

1. **Tekanan Darah** (dua lengan, duduk, setelah istirahat 5 menit, manset ukuran sesuai). **≥ 140/90 mmHg = Hipertensi Kehamilan**.
2. **Berat Badan & Tinggi Badan** → IMT. **LILA** (pada trimester 1 & 2, atau jika BB tidak naik).
3. **Tinggi Fundus Uteri (TFU)** vs Usia Kehamilan (UK) → Deteksi KEG / Makrosomia / Polihidramnios / Oligohidramnios.
4. **Denyut Jantung Janin (DJJ)** Doppler/Pinard. **Normal 110-160 x/menit**.
5. **Presentasi & Posisi Janin** (Leopold) → Malpresentasi > 34-36 mgg.
6. **Edema** (kak, tangan, wajah) — Tanda preeklampsia berat.
7. **Pemeriksaan Vulva/Spekulum** (jika indikasi: pendarahan, infeksi, PROM).
...
### 4. **Penilaian & Klasifikasi Risiko (Scoring)**

1. **Hitung Total Skor Poedji Rochjati** dari anamnesis + fisik + penunjang.
2. **Klasifikasikan**:
   - **Risiko Rendah (Skor < 5)**: ANC standar (K1-K4 + K6), persalinan fasilitas dasar.
   - **Risiko Sedang (Skor 5-9)**: ANC tambahan (K1-K4 + K5-K6 + K7/K8), persalinan RS Tipe C/D (Sp.OG).
   - **Risiko Tinggi (Skor ≥ 10)**: ANC intensif (mingguan/2 mingguan), persalinan RS Tipe A/B / RS Rujukan Nasional (Sp.OG, Anestesi, NICU, Bank Darah, ICU).
3. **Catat di Kartu KIA** (Halaman Skrining Risiko) & **Formulir Rujukan** jika perlu.

---

### 5. **Komunikasi Risiko & Rencana Penatalaksanaan (Risk Communication)**

1. **Jelaskan Hasil Screening** dengan bahasa sederhana: "Ibu memiliki beberapa faktor risiko yang membuat kehamilan ini butuh perhatian ekstra."
2. **Bahas Implikasi**: Risiko pada ibu (preeklampsia, PPH, KS darurat) & janin (KEG, prematuritas, asfiksia, kelainan kongenital).
3. **Rencanakan ANC Lanjutan**: Jadwal kunjungan, pemeriksaan tambahan, konsultasi Sp.OG/Sp.PD/Sp.A.
4. **Rencanakan Tempat & Cara Persalinan**: Berdasarkan skor & kondisi terkini. **Birth Plan & Complication Readiness Plan (CRP)**.
5. **Edukasi Tanda Bahaya (JACHES/ALARM SIGNS)**: Nyeri kepala hebat, penglihatan kabur, nyeri perut atas, edema wajah/tangan, pendarahan vagina, gerakan janin berkurang, kontraksi teratur < 37 mgg, demam.
6. **Buat Surat Rujukan** (jika skor ≥ 5 / komplikasi aktif) format **SBAR** + lampiran hasil lab/USG.

---

### 6. **Dokumentasi & Follow-up**

- Catat di **Buku KIA**, **Register ANC Puskesmas**, **Sistem Informasi (e-Puskesmas / SATUSEHAT)**.
- **Jadwal Kontrol Ulang** sesuai kategori risiko.
- **Koordinasi dengan Bidan/Puskesmas/RS Rujukan** (telepon/WA/grup koordinasi).
- **Evaluasi Ulang Setiap Kunjungan** — risiko bisa berubah (naik/turun).
...
> - **Preterm Labor**: Kontraksi teratur + serviks pembukaan ≥ 2 cm / pengipisan ≥ 80% pada UK < 37 mgg.
> - **PROM < 37 mgg** (PPROM): Risiko infeksi (korioamnionitis), prematuritas, prolapsus funis.
> - **Infeksi Sistemik**: Demam > 38°C, Takikardi, Leukositosis, Tanda sepsis (qSOFA ≥ 2).
> - **Gangguan Gerak Janin**: Kurang dari 10 gerakan / 12 jam (Count-to-10) / DJJ < 110 / > 160 / Deceleration berulang.
...
1. **Kemenkes RI – Pedoman Pelayanan Antenatal (ANC) Terpadu** (2020, Revisi 2022)
2. **Kemenkes RI – Buku KIA (Maternal Child Health Handbook)** Edisi 2020
3. **Poedji Rochjati Score Card – Kemenkes** (Versi 2020 Update)
4. **WHO – Recommendations on Antenatal Care for a Positive Pregnancy Experience** (2016)
5. **WHO – Labour Care Guide & Antenatal Risk Classification** (2020)
6. **POGI – Buku Saku Obstetri & Ginekologi Edisi 5** (2021) – Modul Antenatal: Skrining Risiko
7. **Buku Saku Manajemen Kehamilan Risiko Tinggi – Kemenkes/BKKBN** (2021)
8. **ACOG Practice Bulletin No. 202** (2019) – Gestational Hypertension and Preeclampsia
9. **ACOG Practice Bulletin No. 190** (2018) – Gestational Diabetes Mellitus
10. **SMFM Consult Series** – Fetal Growth Restriction, Preterm Labor, Stillbirth Prevention
11. **UpToDate – Antenatal Care: Initial Assessment / High-Risk Pregnancy Screening** (2024)
12. **KTD/K3RS Kemenkes – Standar Rujukan Maternal & Neonatal** (2022)
