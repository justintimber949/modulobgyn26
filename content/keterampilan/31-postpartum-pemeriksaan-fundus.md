---
title: Pemeriksaan Tinggi Fundus Postpartum
tags:
- keterampilan
- persalinan
- skdi-4a
...
- TFU Postpartum
- Pemeriksaan Plasenta Lepas
- Retensio Plasenta
- Tanda Kustner
- Tanda Schroeder
- Tanda Strassman
- Kala IV
- Observasi Nifas Segera
- tfp postpartum
- cek fundus nifas
- ukur tinggi fundus
- cek plasenta lepas
...
**Perdarahan postpartum (PPP)** tetap menjadi penyebab utama kematian ibu di Indonesia (30% dari seluruh kematian ibu), dengan risiko tertinggi pada **2 jam pertama** setelah persalinan (kala IV). Tiga mekanisme utama perdarahan postpartum — *tone* (atonia uteri — 70%), *trauma* (robekan jalan lahir — 20%), dan *tissue* (retensio plasenta/sisa plasenta — 10%) — semuanya dapat dideteksi lebih awal melalui **pemeriksaan tinggi fundus postpartum yang sistematis**.

Keterampilan ini menjadi jembatan kritis antara [[27-menolong-persalinan-fisiologis-apn]] (kala III) dan [[32-memperkirakan-kehilangan-darah]] (estimasi perdarahan). Tanpa kemampuan menilai tinggi fundus dan mendeteksi tanda-tanda pelepasan plasenta secara tepat, risiko *missed diagnosis* retensio plasenta, perdarahan postpartum yang tertunda, dan subinvolusi uterus meningkat secara signifikan.
...
> Ny. B, 32 tahun, G3P2A0, melahirkan di **RSKH Ibu dan Anak Pertiwi** dengan BB lahir 3.600 g. Setelah 15 menit, plasenta belum lahir. Tanda Kustner negatif, Schroeder negatif, perdarahan aktif ±300 cc. Dilakukan *manual removal of placenta* di kamar bersalin; plasenta ditemukan melekat parsial. Pasca evakuasi, kontraksi uterus membaik, TFU turun 2 jari di bawah pusat.

> **Vignette 3 — Subinvolusi Postpartum:**
> Ny. C, 24 tahun, primipara, 6 hari postpartum kontrol di poliklinik **RSKH Melati**. TFU masih 2 jari di bawah pusat (seharusnya 6 jari di bawah pusat — involusi lambat). Lochea rubra masih ada, berbau agak anyir. Dicurigai sisa plasenta + endometritis. Dilakukan USG: ditemukan *retained product of conception* (RPOC) 3×2 cm. Dilakukan Kuretase atas indikasi sisa plasenta.
...
> - **Hari 6** → TFU **6 jari di bawah pusat** (~6 cm) — *setinggi simfisis*
...
```mermaid
flowchart LR
    A["0 jam postpartum<br>TFU = Pusat"] --> B["Hari 1<br>TFU = 1 jari ↓ pusat"]
    B --> C["Hari 2<br>TFU = 2 jari ↓ pusat"]
    C --> D["Hari 3<br>TFU = 3 jari ↓ pusat"]
    D --> E["Hari 4<br>TFU = 4 jari ↓ pusat"]
    E --> F["Hari 5<br>TFU = 5 jari ↓ pusat"]
    F --> G["Hari 6<br>TFU = 6 jari ↓ pusat<br>(= simfisis)"]
    G --> H["Hari 7–10<br>TFU tidak teraba"]
```
...
| Tidak ada lokhea sama sekali (lokhea stasis) | *Lochiometra* | USG + dilatasi serviks |
...
Tiga tanda klasik pelepasan plasenta dari dinding uterus — dinamai dari para ahli obstetri abad ke-19/20 — harus diperiksa secara berurutan sebelum memutuskan untuk melakukan *controlled cord traction* (CCT) atau *manual removal of placenta*.
...
| **Positif (Plasenta Lepas)** | Uterus berubah bentuk menjadi **bulat, keras, dan lebih kecil**, serta **teraba naik ke atas** (ke arah umbilikus). Bentuk uterus menjadi *globular*. Posisi fundus naik hingga setinggi pusat atau sedikit di atasnya. |
...
```mermaid
flowchart LR
    A["Sebelum Plasenta Lepas"] --> B["Bentuk discoid/ceper<br>Lebar, datar, tidak keras"]
    C["Setelah Plasenta Lepas"] --> D["Bentuk globular/bulat<br>Keras, kecil, terangkat naik"]
```
...
```mermaid
flowchart TD
    A["Bayi Lahir"] --> B["Tunggu kontraksi uterus muncul<br>(biasanya 2–5 menit)"]
    B --> C["Palpasi fundus + Tanda Schroeder"]
    C --> D{"Bentuk globular?<br>Fundus naik?"}
    D -- Ya --> E["Kompresi uterus + Tanda Kustner"]
    D -- Tidak --> F["Tunggu 5–10 menit<br>Beri oksitosin 10 IU IM"]
    F --> C
    E --> G{"Tali pusat tetap?"}
    G -- Ya (plasenta lepas) --> H["Lakukan CCT<br>(Controlled Cord Traction)"]
    G -- Tidak (belum lepas) --> I["Tunggu 3–5 menit<br>ulangi penilaian"]
    I --> C
    H --> J{"Plasenta lahir?"}
    J -- Ya --> K["Periksa kelengkapan plasenta<br>dan selaput ketuban"]
    J -- Tidak --> L{"Setelah 15–30 menit?"}
    L -- Ya --> M["Manual Removal of Placenta<br>atau rujuk"]
```
...
| **Timbangan + ukuran** | Menimbang pembalut untuk estimasi perdarahan (lihat [[32-memperkirakan-kehilangan-darah]]) |
...
1. **Informed consent** — jelaskan bahwa pemeriksaan TFU dan pantauan perdarahan akan dilakukan secara berkala selama 2 jam pertama dan setiap 4–6 jam berikutnya.
   > *"Ibu, kami akan memeriksa perut Ibu secara berkala untuk memastikan rahim ibu mengerut dengan baik dan tidak ada perdarahan berlebihan. Tolong beri tahu kalau ada rasa nyeri atau keluar darah banyak."*
...
3. **Posisi Ibu** — berbaring telentang (*dorsal recumbent*) dengan lutut sedikit ditekuk, agar abdomen rileks untuk palpasi fundus.
...
> - Tekan perlahan dari arah umbilikus ke bawah hingga teraba *kubah* fundus.
...
> [!tip] **Estimasi Cepat Kehilangan Darah — Lihat [[32-memperkirakan-kehilangan-darah]]:**
> | Jumlah | Tanda Klinis |
> |--------|-------------|
...
- Oksitosin 10 IU IM dalam 1 menit pertama setelah bayi lahir (lihat [[27-menolong-persalinan-fisiologis-apn]]).
- *Controlled cord traction* hanya setelah ada tanda pelepasan.
...
2. **Tangan kiri** melakukan *counter-traction* dengan mendorong uterus ke arah kranial-ventral (**jangan dorong fundus!** — dorong segmen bawah uterus di atas simpisis).
...
5. **Segera periksa plasenta:** *maternal surface* — utuh/tidak? Selaput — lengkap? Tali pusat — 2 arteri + 1 vena? (lihat ilustrasi di bawah).
...
>   - **Bila perdarahan <500 cc dan plasenta belum lepas >15–30 menit** → lakukan *manual removal of placenta*.
>   - **Bila perdarahan >500 cc** → segera lakukan *manual removal of placenta*.
...
| Tepi plasenta menyerupai *tanah longsor* | *Sudden separation* — curigai solusio | Catat, evaluasi perdarahan |

#### Pemeriksaan Fetal Surface (Selaput Ketuban)

| Temuan | Interpretasi | Tindakan |
|--------|-------------|----------|
| Selaput utuh, *ammion* dan *chorion* tercermin | Lengkap | Tidak perlu tindakan |
| Ada robekan selaput — selaput tidak lengkap | Sebagian selaput tertinggal | Observasi — biasanya keluar spontan |
| Sobekan melingkar mengelilingi plasenta (*circumvallate* atau *circummarginate*) | Variasi normal | Catat |
...
| Hanya 1 arteri (2 pembuluh darah total) | *Single umbilical artery* — kaitkan dengan kelainan kongenital |
| Panjang >100 cm | Panjang abnormal — risiko *nuchal cord* |
| Panjang <30 cm | *Short cord* — risiko solusio/inversio |
| Tali pusat sangat tipis | Curigai *jejune cord* |
...
2. Catat total estimasi perdarahan (lihat [[32-memperkirakan-kehilangan-darah]]).
...
| TFU turun lebih cepat dari normal (< 1 jari per hari adalah *lambat*, bukan cepat) | — | Tidak ada masalah — involusi normal (tidak perlu dikhawatirkan turun cepat) |
...
|--------|-------|----------|
| Plasenta belum lahir > 30 menit | *Retained placenta* (retensio plasenta) | Manual removal of placenta |
...
| **Tidak melibatkan pasien dalam edukasi tanda bahaya** | Pasien pulang tanpa tahu kapan harus kembali | Edukasi: *"Bila perdarahan seperti haid berat atau demam atau nyeri perut hebat, segera kembali"* |
...
> Teknik *Crede's maneuver* (mendorong fundus untuk melahirkan plasenta) sudah **ditinggalkan** karena risiko inversio uteri yang tinggi. Gunakan CCT dengan panduan Kustner, bukan Crede.

> [!danger] **Kesalahan Fatal #3 — Memotong Tali Pusat Terlalu Dekat Pangkal**
> Saat plasenta belum lahir dan tali pusat putus karena traksi berlebihan, jangan memotong sisa tali pusat — ini adalah *landmark* untuk menemukan sisa plasenta di intrauterin. Biarkan sisa tali pusat menjulur dari serviks sebagai panduan.
...
1. **Cunningham FG, et al.** *Williams Obstetrics*. 26th Ed. McGraw-Hill; 2022. — Bab 35: The Third Stage of Labor, Bab 36: The Fourth Stage of Labor, Bab 41: Postpartum Hemorrhage.
2. **Prawirohardjo S, Wiknjosastro H.** *Ilmu Kebidanan*. Edisi 4. Jakarta: PT Bina Pustaka Sarwono Prawirohardjo; 2014. — Bab 28: Kala III, Bab 29: Kala IV, Bab 30: Perdarahan Postpartum.
3. **Saifuddin AB.** *Buku Praktis Pelayanan Kesehatan Maternal dan Neonatal*. Jakarta: Yayasan Bina Pustaka Sarwono Prawirohardjo; 2018.
4. **Kementerian Kesehatan RI.** *Buku Saku Pelayanan Kesehatan Ibu di Fasilitas Kesehatan Tingkat Pertama*. Jakarta: Direktorat Gizi dan Kesehatan Ibu dan Anak; 2019.
...
6. **WHO.** *WHO Recommendations for the Prevention and Treatment of Postpartum Haemorrhage*. Geneva: World Health Organization; 2012.
7. **FIGO.** *Active Management of the Third Stage of Labour: Prevention and Treatment of Postpartum Hemorrhage*. FIGO Safe Motherhood and Newborn Health Committee; 2016.
8. **ACOG.** *Practice Bulletin No. 183: Postpartum Hemorrhage*. American College of Obstetricians and Gynecologists; 2017 (reaffirmed 2020).
9. **POGI.** *Pedoman Nasional Pelayanan Kedokteran: Perdarahan Postpartum*. Jakarta: Perkumpulan Obstetri dan Ginekologi Indonesia; 2020.
10. **Begley CM, et al.** *Active versus expectant management for women in the third stage of labour*. Cochrane Database of Systematic Reviews; 2019. — Bukti tingkat tinggi untuk AMTSL.
...
> - Terintegrasi dengan [[27-menolong-persalinan-fisiologis-apn]] (tatalaksana kala III–IV) dan [[32-memperkirakan-kehilangan-darah]] (estimasi perdarahan).
