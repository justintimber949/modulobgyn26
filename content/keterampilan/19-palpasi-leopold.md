...
Seorang perempuan G1P0A0 usia 22 tahun datang ke RSKH (Rumah Sakit Khusus Hewan) — maksud kami, RSKH (Rumah Sakit Kesehatan Ibu dan Anak) untuk pemeriksaan kehamilan rutin. Usia kehamilan 36 minggu berdasarkan HPHT. Pasien mengeluh perut terasa kencang-kencang sejak 2 hari yang lalu, tidak disertai perdarahan atau pengeluaran cairan. Pemeriksaan tanda vital dalam batas normal. Sebagai dokter jaga, kamu perlu melakukan **palpasi Leopold** untuk menentukan posisi, presentasi, dan perkiraan berat janin — data penting untuk merencanakan persalinan. Apakah letak sungsang atau kepala? Apakah sudah masuk panggul atau masih floating? Leopold adalah jawabannya.
...
**Tidak ada kontraindikasi absolut.** Palpasi Leopold aman untuk ibu dan janin. Namun lakukan **lebih hati-hati** pada:

- Plasenta previa (curiga perdarahan antepartum) — palpasi lembut, jangan terlalu dalam
- Persalinan preterm / ancaman preterm — hindari rangsangan berlebihan pada uterus
- Pasien dengan nyeri abdomen akut — bedakan sumber nyeri (abruptio plasenta, kontraksi, atau lainnya)
- Pasien dengan skar uterus (post SC) — palpasi lembut, perhatikan nyeri atau kontraksi abnormal
...
1. **Informed consent** — "Bu, saya akan meraba perut Ibu untuk merasakan posisi dan posisi punggung bayi. Rasanya tidak sakit, hanya sedikit ditekan."
2. **Posisi** — dorsolithotomi (supine) dengan kedua lutut sedikit ditekuk dan bantal kecil di bawah kepala. Paha tidak perlu dibuka lebar — cukup rileks.
3. **Kencing kosong** — minta pasien BAK terlebih dahulu. Kandung kemih penuh mendistorsi palpasi dan membuat pasien tidak nyaman.
4. **Buka pakaian perut** — perut terbuka dari prosesus xifoideus sampai simfisis pubis. Beri selimut penutup ekstremitas.
5. **Atur pencahayaan** — lampu cukup untuk melihat kontur perut.
6. **Hangatkan tangan** — tangan dingin menyebabkan kontraksi otot perut (defens muskuler) yang mengganggu palpasi.

### Persiapan Dokter

- Cuci tangan atau handrub berbasis alkohol.
- Kuku jari pendek.
- Duduk atau berdiri di sisi kanan pasien (bagi dokter yang tidak kidal).
- Posisikan diri sejajar dengan perut pasien.
...
> [!tip] Prinsip Dasar
> Palpasi Leopold dilakukan **berurutan dari I ke IV**. Jangan melompat — setiap langkah membangun informasi untuk langkah selanjutnya. Gunakan **telapak tangan dan sisi ulnar**, bukan ujung jari, agar palpasi lebih sensitif.

---

### Langkah I: Tinggi Fundus & Bagian Janin di Fundus

**Tujuan:** Menentukan tinggi fundus uteri (TFU) dan bagian janin apa yang berada di fundus (bokong atau kepala).

#### A. Mengukur Tinggi Fundus Uteri (TFU)

**Teknik McDonald:**

1. Letakkan pasien dalam posisi supine dengan kaki lurus.
2. Rentangkan meteran dari **tepi atas simfisis pubis** (bagian tulang yang keras, bukan jaringan lunak) sampai **puncak fundus uteri** (titik tertinggi perut yang masih padat).
3. Baca hasil dalam **sentimeter** (cm).
4. Catat: TFU = ... cm.

**Rumus McDonald:**

> **Usia kehamilan (minggu) ≈ TFU (cm) ± 2 minggu**
> (berlaku pada kehamilan 20–36 minggu)
...
#### B. Palpasi Fundus (Bagian Janin di Fundus)

Setelah mengukur TFU:

1. Hadapkan telapak tangan ke arah fundus.
2. Letakkan kedua tangan di fundus dengan jari-jari saling berhadapan dan sisi ulnar menyentuh fundus.
3. Tekan **dengan gerakan melingkar dan perlahan** — rasakan bagian janin mana yang berada di fundus.
4. Gunakan **gerakan ballotement** ringan jika perlu: goyangkan fundus dengan telapak tangan untuk merasakan bola besar yang memantul.
...
### Langkah II: Letak Punggung Janin (Dorso & Ekstremitas)

**Tujuan:** Menentukan di sisi mana punggung janin (dorso) berada dan di sisi mana teraba bagian-bagian kecil janin (ekstremitas / kaki-tangan).

1. Kedua tangan digeser ke lateral perut (dari posisinya setelah langkah I).
2. Letakkan satu tangan di setiap sisi perut — dengan tekanan ringan dan gerakan **menekan masuk** (deep pressure), raba dari lateral ke medial.
3. Gunakan **sisi radial tangan** untuk merasakan tahanan yang diberikan oleh janin.
4. Bergerak dari atas ke bawah (dari fundus ke bagian bawah perut) secara sistematis.
...
### Langkah III: Presentasi Janin (Bagian Terbawah)

**Tujuan:** Menentukan bagian janin yang berada di segmen bawah rahim (SBR) — bagian yang akan lahir pertama.

**Teknik:**

1. Berdiri atau duduk menghadap ke arah kaki pasien (atau dari samping — mana yang nyaman untuk Anda).
2. Letakkan **sisi ulnar satu tangan** (atau tangan kanan) secara vertikal di bagian bawah perut ibu, tepat di atas simfisis pubis.
3. Jepit bagian bawah perut antara ibu jari dan jari telunjuk/jari tengah — lakukan palpasi seolah-olah "mencubit" perlahan.
4. Gunakan gerakan ballotement ringan: tekan bagian terbawah lalu lepaskan — rasakan bola yang memantul.
...
### Langkah IV: Engagement (Penurunan Bagian Terbawah)

**Tujuan:** Menentukan seberapa jauh bagian terbawah janin masuk ke dalam rongga panggul (PAP — Pintu Atas Panggul).

**Teknik:**

1. Berdiri menghadap ke arah kaki pasien.
2. Letakkan kedua tangan pada segmen bawah rahim, dengan **jari-jari menghadap ke simfisis**.
3. Tekan kedua tangan **ke arah posterior dan inferior** (ke arah panggul) — seolah-olah meraba bagian terbawah janin yang masuk ke PAP.
4. Nilai berapa **jari** yang masuk antara bagian terbawah janin dan simfisis pubis.
...
Setelah semua langkah Leopold selesai, hitung TBJ menggunakan rumus:

**Rumus Johnson-Toshach (paling umum):**
...
> [!warning] Keterbatasan TBJ
> TBJ dengan rumus hanya merupakan **estimasi kasar**. Akurasi ± 250–500 gram dari berat lahir nyata. Faktor yang mempengaruhi: obesitas ibu, polihidramnion, kehamilan ganda, kesalahan pengukuran TFU.

---

### Mendengarkan DJJ (Denyut Jantung Janin)

Setelah seluruh palpasi Leopold selesai, lakukan auskultasi DJJ:

1. Gunakan stetoskop monoaural (Pinard / Laënnec) atau Doppler.
...
> [!warning] Bradikardia (< 120 dpm) atau takikardia (> 160 dpm) memerlukan evaluasi lanjut — curiga gawat janin (fetal distress).

---

## Interpretasi Hasil & Klasifikasi Posisi Janin

Setelah semua langkah selesai, gabungkan temuan untuk menentukan **posisi janin lengkap**.

### Format Dokumentasi Leopold

Contoh lengkap:

> **Leopold**: TFU 32 cm, 1 jari di bawah prosesus xifoideus. Leopold I: teraba bokong di fundus. Leopold II: punggung janin di sisi kiri, ekstremitas di kanan. Leopold III: presentasi kepala (teraba kepala ballotable). Leopold IV: kepala sudah engaged (Hodge II, 2 jari divergen). DJJ 140 dpm, reguler, terdengar di kuadran kiri bawah perut.
> **Kesan**: G1P0A0, hamil 32 minggu, tunggal, hidup, presentasi kepala, dorso kiri, engaged. TBJ ≈ 1.860 gram.
...
## Tanda Bahaya pada Palpasi Leopold
...
> - Leopold IV: ... (engaged / floating), Hodge ...
> - DJJ: ... dpm, reguler / ireguler, terdengar di ...
> - TBJ (Johnson-Toshach): ... gram

**Contoh singkat:**

> **Leopold**: TFU 30 cm (½ pusar–xifoideus). Leopold I: bokong fundus. Leopold II: dorso kiri, ektremitas kanan. Leopold III: presentasi kepala, ballotable. Leopold IV: engaged (Hodge II). DJJ 140 dpm, reguler, kiri bawah. TBJ ≈ 2.790 gram. **Kesan**: Hamil 30 mg, tunggal, hidup, presentasi kepala, PUK, engaged.

---

## Dipakai Untuk Penyakit Apa Saja

- **Kehamilan normal** — ANC rutin, evaluasi pertumbuhan dan posisi janin
- **IUGR (Intrauterine Growth Restriction)** — TFU < usia gestasi > 2 cm
- **Makrosomia** — TFU > usia gestasi > 2 cm, TBJ > 4.000 gram
- **Letak sungsang** — presentasi bokong di SBR
- **Letak lintang** — tidak ada bagian padat di SBR, sumbu janin melintang
- **Kehamilan ganda** — teraba 2 bagian besar, TFU > usia gestasi
- **Polihidramnion** — TFU besar, palpasi janin sulit, ballotement berlebihan
- **Oligohidramnion** — TFU kecil, janin teraba jelas
- **CPD (Cephalo-Pelvic Disproportion)** — kepala belum engaged pada primigravida aterm
- **Prolaps tali pusat** — terutama pada persalinan sungsang (antisipasi dengan temuan Leopold)
- **Gawat janin** — DJJ abnormal saat auskultasi pasca-Leopold
- **Kehamilan postterm (≥ 42 mg)** — TFU bisa turun karena lightening
- **Plasenta previa** — hati-hati palpasi dalam, jangan Leopold IV terlalu kuat

---

## Catatan Medikolegal

1. Palpasi Leopold adalah **tindakan non-invasif** dan aman — tetapi dokumentasi tetap penting.
2. Catat **semua temuan** Leopold (I s.d. IV) termasuk TFU, DJJ, dan TBJ.
3. Jika **presentasi sungsang atau letak lintang** terdeteksi pada aterm, dokumentasikan **informed consent** tentang rencana rujukan atau ECV.
4. Jika ditemukan **tanda bahaya** (abnormal DJJ, CPD, dll), catat tindak lanjut yang sudah dilakukan.
5. Dokumentasi Leopold adalah komponen **wajib** dalam rekam medis antenatal.
