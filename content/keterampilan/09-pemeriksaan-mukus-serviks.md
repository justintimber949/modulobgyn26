...
Mukus serviks bukan sekadar "lendir" biasa. Ia adalah **cermin hormonal** yang dapat dibaca secara langsung di samping tempat tidur pasien. Sifat fisik dan kimiawi mukus serviks berubah secara dramatis di bawah pengaruh estrogen dan progesteron, dan perubahan ini bisa dideteksi dengan alat sederhana — spekulum, kaca objek, dan mikroskop cahaya.

Tes fern (tes pakis / arborization test) adalah salah satu tes **tercepat dan termurah** untuk menilai status estrogenik seorang wanita. Dalam hitungan menit, Anda bisa mendapat informasi yang setara dengan kadar estradiol serum — tanpa menunggu hasil laboratorium.
...
> [!tip] Ingat: Kelenjar endoserviks adalah target organ yang sangat sensitif terhadap estrogen.

**Kelenjar endoserviks** — dilapisi epitel kolumnar — adalah pemroduksi utama mukus serviks. Sekresinya mencapai puncak sekitar 0,5–1 mL/hari di masa subur. Mukus sendiri tersusun atas:

- **Air** (~90–98%) — proporsi air meningkat drastis saat estrogen tinggi.
- **Elektrolit** (NaCl terutama) — garam inilah yang mengkristal menjadi pola pakis di tes fern.
- **Protein** (mucin, albumin, globulin) — mucin memberikan viskositas.
- **Enzim** dan zat imunologis (IgA, IgG, lactoferrin, lisozim).

Pada fase folikular awal (estrogen rendah), mukus sedikit, kental, dan seluler. Menjelang ovulasi (puncak estrogen), mukus menjadi **jernih, encer, berlimpah, elastis (spinmbarkeit tinggi), dan alkali (pH 7–8.5)** — lingkungan ideal sperma. Setelah ovulasi, progesteron mengubah mukus menjadi **kental, opak, sedikit, dan lengket** — membentuk sumbat yang menghalangi sperma dan bakteri.
...
6. **Dismenore / perdarahan uterus abnormal** — sebagai bagian evaluasi hormonal awal.
...
1. **Informed consent** — jelaskan prosedur singkat: "Bu, saya akan memasang spekulum untuk melihat liang dan mulut rahim, lalu mengambil sedikit lendir untuk diperiksa. Tidak perlu takut, mirip seperti pap smear."
2. Pasien dalam posisi **litotomi** — kosongkan kandung kemih terlebih dahulu.
3. Tanyakan HPHT (hari pertama haid terakhir) dan hari siklus ke berapa.
4. Tanyakan apakah sudah coitus dalam 24 jam terakhir — **jika ya, tunda atau catat sebagai keterbatasan interpretasi.**
5. Jangan melakukan douching dalam 24 jam sebelum pemeriksaan.
6. Catat obat-obatan yang sedang diminum — terutama kontrasepsi hormonal, klomifen, atau estrogen.

> [!warning] Bila pasien sedang dalam pengobatan antibiotik atau antifungal vagina, hasil tes fern bisa terganggu karena perubahan flora dan pH vagina. Catat di rekam medis.
...
5. **Inspeksi serviks** — lihat warna, erosi, lesi, polip, atau sekret abnormal.
6. **Bersihkan serviks** — usap perlahan permukaan serviks dengan kapas/kasa steril untuk menghilangkan sekret vagina yang menempel.
7. **Ambil mukus endoserviks** — gunakan salah satu cara:
   - **Pinset / korentang** — jepit mukus yang keluar dari ostium eksternum, tarik perlahan (ukur spinmbarkeit langsung).
   - **Kapas lidi steril** — putar perlahan di ostium eksternum untuk mendapatkan mukus.
   - **Pipet / spuit tanpa jarum** — aspirasi langsung dari kanalis servikalis.

### B. Penilaian Kualitas Mukus (Skor Insler)

> [!tip] Skor Insler adalah sistem penilaian **semikuantitatif** kualitas mukus serviks, dipublikasikan oleh Insler et al. (1972). Skor 0–15; skor ≥10 umumnya dianggap **baik / subur**.
...
### C. Tes Spinmbarkeit (Elastisitas Mukus)

Tes ini mengukur **kemampuan mukus meregang** tanpa putus. Dilakukan **segera** setelah pengambilan.

1. Ambil mukus yang keluar dari ostium eksternum dengan pinset / korentang.
2. Buka kedua ujung pinset perlahan, atau rekatkan mukus ke kaca objek kedua dan tarik.
3. Ukur **panjang benang mukus** (dalam cm) sebelum putus.
4. Catat panjang maksimum — gunakan penggaris jika perlu.
...
### D. Tes Fern (Arborization / Tes Kristalisasi / Tes Pakis)

Tes fern adalah tes kualitatif yang mendeteksi **kristalisasi mukus serviks** akibat kadar NaCl yang tinggi di bawah pengaruh estrogen.

#### Prinsip Dasar

Estrogen tinggi → mukus kaya NaCl dan air → saat mukus dikeringkan di udara, **NaCl mengkristal** membentuk pola dendritik menyerupai daun pakis (fern). Progesteron menghambat kristalisasi → pola fern negatif.

#### Cara Melakukan

1. Ambil mukus serviks (langkah A).
2. Oleskan setetes mukus setebal **±1–2 mm** di tengah kaca objek bersih.
3. **Biarkan mengering di udara** selama **5–10 menit** — jangan difiksasi dengan alkohol atau dipanaskan! Pemanasan atau fiksasi merusak kristal NaCl.
4. Baca di bawah mikroskop cahaya — mulai perbesaran **10×**, lalu konfirmasi dengan **40×**.
5. Amati pola kristalisasi di seluruh area olesan.

> [!warning] **Kesalahan fatal:** Jangan memanaskan kaca objek atau menggunakan pengering rambut! Kristal NaCl hanya terbentuk saat mukus mengering perlahan pada suhu kamar. Pemanasan mempercepat penguapan secara tidak merata dan merusak pola dendritik. Jangan juga mem-fiksasi dengan alkohol — alkohol melarutkan NaCl!
...
#### Tes Fern untuk Diagnosis KPD (Ketuban Pecah Dini)

Salah satu aplikasi paling sering di **obstetri**:

1. Ambil sampel cairan yang keluar dari **forniks posterior posterior** (jangan dari endoserviks — mukus serviks normal memberi fern positif di masa subur!).
2. Oleskan pada kaca objek.
3. Keringkan 5–10 menit, baca di mikroskop.
4. **Fern positif → cairan ketuban** (mengandung NaCl dan protein yang mengkristal).
...
## Contoh Skenario Klinis (Vignette)
...
> - **Seluleritas:** 2 sel/LPB (skor 2)
> - **Total Skor Insler: 11** (baik)
> - **Tes fern:** pola +3 (pakis sempurna)
>
> **Interpretasi:** Ny. Sari sedang dalam masa subur puncak. Ovulasi diperkirakan dalam 24–48 jam. Anjurkan hubungan seksual setiap 1–2 hari. Lanjutkan dengan folikulometri jika diperlukan.
...
> - Spinmbarkeit: <1 cm.
> - Skor Insler: 2.
> - Tes fern: **negatif (grade 0)**.
>
> **Interpretasi:** Defisiensi estrogen berat → perlu dicari penyebabnya (hipogonadotropik? hiperprolaktinemia? premature ovarian insufficiency?). Lanjutkan pemeriksaan hormonal: FSH, LH, estradiol, prolaktin.

---

## Komplikasi / Risiko Prosedur
...
> 4. Interpretasi (apakah konsisten dengan fase siklus?).
...
Pasien dengan indikasi
        ↓
Tanya HPHT, siklus, koitus 24 jam, obat
        ↓
Inspekulo → ambil mukus dari ostium eksternum
        ↓
        ├──→ Skor Insler (jumlah + viskositas + spinmbarkeit + seluleritas)
        ├──→ Tes spinmbarkeit (ukur panjang benang)
        └──→ Oles ke kaca objek → keringkan 5–10' → mikroskop 10×
                    ↓
              Grade fern (0 – +4)
                    ↓
        Interpretasi → sesuai fase siklus?
                    ↓
        Dokumentasi + catat di rekam medis
```
