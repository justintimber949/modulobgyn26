...
**Laserasi perineum** terjadi pada 50–85% persalinan per vaginam; mayoritas derajat 1–2 yang memerlukan penjahitan. Penjahitan yang tepat dan cepat menghentikan perdarahan, mencegah infeksi, memulihkan anatomi dasar panggul, mengurangi nyeri postpartum, dan memberikan hasil kosmetik baik.
...
## Anatomi & Klasifikasi untuk Penjahitan
...
1. Identifikasi anatomi sebelum menusukkan jarum — cari ujung laserasi, batas tiap lapisan.
2. Eksposur baik: gunakan spekulum, asisten menarik dinding posterior vagina.
3. Bersihkan luka: irigasi NaCl 0,9%, keluarkan bekuan darah dan debris.
4. Mulai dari ujung terdalam: jahit dari puncak laserasi vagina → arah fourchette.
5. Jarum masuk 5–10 mm dari tepi luka — tidak terlalu dekat (robek) atau terlalu jauh (jaringan mati).
6. Interval jahitan 8–10 mm — cukup rapat untuk hemostasis.
7. Approksimasi rapat — bukan strangulasi. Tepi luka bersentuhan, tidak tumpang tindih.
8. Pastikan hemostasis tiap lapisan sebelum lanjut.

### B. Laserasi Derajat 1
...
### C. Laserasi Derajat 2 + Episiotomi

**WAJIB tiga lapis terpisah.** Selesaikan dalam 15–20 menit.

#### Lapisan 1 — Mukosa Vagina + Submukosa

**Tujuan:** Hemostasis, menutup lapisan dalam.
...
#### Lapisan 2 — Otot Perineum

**Tujuan:** Mengembalikan kontinuitas otot dasar panggul.
...
4. Alternatif: jelujur sederhana untuk robekan otot panjang dan lurus.
5. **Pusat tendon perineum** — reapproksimasi penting untuk fungsi dasar panggul (tempat bertemunya bulbospongiosus, transversus perinei, sfingter ani eksternus).
6. Cek hemostasis — kompresi kasa 1–2 menit. Hilangkan dead space (penyebab hematoma).

#### Lapisan 3 — Subkutis + Kulit

**Tujuan:** Menutup tanpa dead space, hasil kosmetik baik.
...
**Kulit — Opsi 3: Jahitan Matras Vertikal (Donati)**
Untuk kulit tegang atau tepi inverted. Tusuk pertama 5–8 mm (luar→dalam, tembus subkutis), tusuk kedua 2–3 mm (dalam→luar, dermis saja). Lakukan kedua sisi → ikat. Efek: everting tepi luka.

### D. Pemeriksaan Akhir

1. **Inspeksi** seluruh luka — jangan lewatkan laserasi dinding lateral vagina, periuretral, labia.
2. **Palpasi rektal — WAJIB.** Masukkan jari (lubrikasi) ke rektum, raba dinding anterior sepanjang jahitan. Jika teraba benang → **jahitan tembus rektum** → cabut segera, jahit ulang lebih superfisial.
3. **Kompresi** kasa 1–2 menit.
4. **Hitung kasa** — pastikan sesuai jumlah awal.
5. **Pasang pembalut steril.**
6. **Dokumentasi:** derajat laserasi, panjang, jumlah jahitan per lapisan, benang, perdarahan, hasil palpasi rektal, komplikasi.

---

## Ringkasan Penjahitan (Cheat Sheet)

```
DERAJAT 1 → mukosa+kulit → jelujur/terputus (chromic 2-0/3-0) — satu lapis

DERAJAT 2 — tiga lapis:

  LAPIS 1 | Mukosa vagina     | Continuous locking | Chromic 2-0
  LAPIS 2 | Otot perineum     | Interrupted 2–4    | Chromic 2-0
  LAPIS 3 | Subkutis + kulit  | Subkutikuler       | Chromic 3-0

  Mulai dari puncak → fourchette
  Safety: jari di rektum!
  PALPASI REKTAL setelah selesai → wajib!
```
...
1. **Tidak identifikasi anatomi** — langsung jahit tanpa lihat. Luangkan 30 detik untuk observasi.
2. **Tanpa anestesi adekuat** — atau tidak tunggu onset 3–5 menit.
3. **Jahitan tembus rektum** — tidak pakai safety maneuver jari di rektum.
4. **Dead space tidak ditutup** → hematoma perineum.
5. **Jahitan terlalu kencang** → iskemia → nekrosis → parut hipertrofik.
6. **Interval terlalu jarang** (> 1,5 cm) → luka menganga.
7. **Mulai dari fourchette ke forniks** (bawah ke atas) — selalu mulai dari puncak.
8. **Laserasi lain terlewat** — dinding lateral vagina, periuretral, labia.
9. **Benang non-absorbable** pada kulit — ibu harus kembali buka jahitan.
10. **Dokumentasi tidak lengkap** — risiko medikolegal.
...
1. **Derajat 1** → mukosa+kulit → satu lapis (jelujur/terputus).
2. **Derajat 2** → mukosa+otot+kulit → tiga lapis terpisah.
3. **Derajat 3–4** → **kenali dan rujuk** ke spesialis.
4. **Benang:** chromic 2-0 (mukosa & otot), chromic 3-0 (kulit).
5. **Mukosa:** continuous locking — hemostasis lebih baik.
6. **Otot:** interrupted — reapproksimasi pusat tendon perineum.
...
> - Disusun berdasarkan WHO, RCOG, ACOG, POGI
