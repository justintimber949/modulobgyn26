...
```mermaid
flowchart TD
    A["Bayi lahir"] --> B["Tali pusat dipotong<br>(setelah berhenti berdenyut)"]
    B --> C["Keringkan bayi<br>Biarkan verniks"]
    C --> D["Letakkan bayi tengkurap<br>di dada ibu<br>Kontak kulit-ke-kulit"]
    D --> E["Selimuti ibu-bayi bersama<br>Pasang topi"]
    E --> F{"Kontak kulit<br>minimal 60 menit"}
    F --> G["Bayi merangkak<br>menuju payudara"]
    G --> H["Bayi menjilat &<br>merangsang putting"]
    H --> I["Bayi melekat &<br>menyusu"]
    I --> J{"Durasi sudah<br>≥60 menit?"}
    J -->|Belum| F
    ...
    style N fill:#f0f8ff,stroke:#4682b4,stroke-dasharray: 5 5
```
